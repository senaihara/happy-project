# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 32 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 35 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 2
...
# 56 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
void smp_l2cap_if_init (void)
{
    tL2CAP_FIXED_CHNL_REG fixed_reg;
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMDBG l2c %s" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };};
...
# 71 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                  ((void *)0)
# 71 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                      ;
...
# 92 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_connect_callback (UINT16 channel, BD_ADDR bd_addr, BOOLEAN connected, UINT16 reason,
                                  tBT_TRANSPORT transport)
{
    tSMP_CB *p_cb = &smp_cb;
    ...
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
    ...
    if (memcmp(bd_addr, p_cb->pairing_bda, 6) == 0) {
        {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s()  for pairing BDA: %08x%04x  Event: %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], (connected) ? "connected" : "disconnected"); };}
...
# 114 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                           1
# 114 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                               ;
...
# 122 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c" 3 4
                                                      ((void *)0)
# 122 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
                                                          );
            }
        } else {
...
# 143 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_data_received(UINT16 channel, BD_ADDR bd_addr, BT_HDR *p_buf)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 *p = (UINT8 *)(p_buf + 1) + p_buf->offset;
    UINT8 cmd ;
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "\nSMDBG l2c %s\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};

    {cmd = (UINT8)(*(p)); (p) += 1;};


    if ((0x0E < cmd) || (0x01 > cmd)) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Ignore received command with RESERVED code 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT", cmd); };};
        free((p_buf));
        return;
    }
    ...
    if (memcmp(&bd_addr[0], p_cb->pairing_bda, 6) == 0) {
        ...
        if (cmd == 0x03) {
            {if (smp_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "in %s cmd = 0x%02x, peer_auth_req = 0x%02x," "loc_auth_req = 0x%02x\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, cmd, p_cb->peer_auth_req, p_cb->loc_auth_req); };}
...
# 204 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_l2c.c"
static void smp_tx_complete_callback (UINT16 cid, UINT16 num_pkt)
{
    tSMP_CB *p_cb = &smp_cb;
    ...
    if (p_cb->total_tx_unacked >= num_pkt) {
        ...
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unexpected %s: num_pkt = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, num_pkt); };};
    }
