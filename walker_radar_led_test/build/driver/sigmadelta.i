# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c"
...
# 15 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 1
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/periph_ctrl.h"
...
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/periph_ctrl.h" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 1
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
...
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h" 1
# 21 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_struct.h"
...
# 19 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/gpio_sd_reg.h" 1
# 20 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h" 2
# 29 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
typedef enum{
...
# 60 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_config(const sigmadelta_config_t *config);
# 77 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_duty(sigmadelta_channel_t channel, int8_t duty);
# 90 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale);
# 102 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sigmadelta.h"
esp_err_t sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num);
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c" 2

static const char* SIGMADELTA_TAG = "SIGMADELTA";
# 28 "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c"
esp_err_t sigmadelta_config(const sigmadelta_config_t *config)
{
    if(!(config->channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 30, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
    if(!(((((config->sigmadelta_gpio < 40 && GPIO_PIN_MUX_REG[config->sigmadelta_gpio] != 0))) && (config->sigmadelta_gpio < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 31, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); }; return (0x102); };
...
esp_err_t sigmadelta_set_duty(sigmadelta_channel_t channel, int8_t duty)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 40, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
...
esp_err_t sigmadelta_set_prescale(sigmadelta_channel_t channel, uint8_t prescale)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 47, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
...
esp_err_t sigmadelta_set_pin(sigmadelta_channel_t channel, gpio_num_t gpio_num)
{
    if(!(channel < SIGMADELTA_CHANNEL_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 54, __FUNCTION__, "SIGMADELTA CHANNEL ERROR"); }; return (0x102); };
    if(!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, SIGMADELTA_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s:%d (%s):%s" "\033[0m" "\n", esp_log_timestamp(), SIGMADELTA_TAG, "/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 55, __FUNCTION__, "SIGMADELTA GPIO NUM ERROR"); }; return (0x102); };
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 56, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 56, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num]))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./sigmadelta.c", 56, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num])); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
