# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 30 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 34 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 35 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
...
# 37 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 2
# 50 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
tL2C_CB l2cb;
# 62 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_bcst_msg( BT_HDR *p_buf, UINT16 psm )
{
    ...
    if (p_buf->offset < 11) {
        {if (l2cb.l2cap_trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - cannot send buffer, offset: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", p_buf->offset); };};
        free((p_buf));
        return;
    }
...
# 117 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_rcv_acl_data (BT_HDR *p_msg)
{
    ...
    tL2C_LCB *p_lcb;
    tL2C_CCB *p_ccb = 
# 123 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                        ((void *)0)
# 123 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                            ;
...
# 135 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                         ((void *)0)
# 135 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                             ) {
            UINT8 cmd_code;
            ...
            if ((p_msg->layer_specific == 0) && (rcv_cid == 1)
                ...
                {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - holding ACL for unknown handle:%d ls:%d" "  cid:%d opcode:%d cur count:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", handle, p_msg->layer_specific, rcv_cid, cmd_code, list_length(l2cb.rcv_pending_q)); };}
                ...
                {if (l2cb.l2cap_trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - rcvd ACL for unknown handle:%d ls:%d cid:%d" " opcode:%d cur count:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", handle, p_msg->layer_specific, rcv_cid, cmd_code, list_length(l2cb.rcv_pending_q)); };}
        ...
        {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - expected pkt start or complete, got: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", pkt_type); };};
        free((p_msg));
        return;
    }
    ...
    {if (l2cb.l2cap_trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - rcv_cid CID: 0x%04x\n" "\033[0m" "\n", esp_log_timestamp(), "BT", rcv_cid); };};

    if (rcv_cid >= 0x0040) {
        if ((p_ccb = l2cu_find_ccb_by_cid (p_lcb, rcv_cid)) == 
# 192 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                              ((void *)0)
# 192 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                  ) {
            {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - unknown CID: 0x%04x" "\033[0m" "\n", esp_log_timestamp(), "BT", rcv_cid); };};
            free((p_msg));
            return;
        }
    }
    ...
    if (hci_len >= 4) {
        ...
        {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - got incorrect hci header" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        free((p_msg));
        return;
    }

    if (l2cap_len != p_msg->len) {
        {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP - bad length in pkt. Exp: %d  Act: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", l2cap_len, p_msg->len); };}
                                                   ;
    ...
    if (rcv_cid == 1) {
        ...
        {if (l2cb.l2cap_trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "GOT CONNECTIONLESS DATA PSM:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", psm); };} ;
    ...
    else if ((rcv_cid >= 4) && (rcv_cid <= (4 + 3 - 1)) &&
             (l2cb.fixed_reg[rcv_cid - 4].pL2CA_FixedData_Cb != 
# 249 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                                                                    ((void *)0)
# 249 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                                                                        ) ) {
        ...
        if (p_ccb == 
# 275 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                    ((void *)0)
# 275 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                        ) {
            free((p_msg));
        } else {
...
# 759 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_process_held_packets(BOOLEAN timed_out)
{
    ...
    if (!timed_out) {
        ...
        {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP HOLD CONTINUE" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    } else {
        {if (l2cb.l2cap_trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "L2CAP HOLD TIMEOUT" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    }
...
# 800 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_init (void)
{
    INT16 xx;
    ...
    l2cb.p_free_ccb_last = &l2cb.ccb_pool[4 - 1];
...
# 848 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
    l2cb.l2c_ble_fixed_chnls_mask =
        (1 << 4) | (1 << 5) | (1 << 6);


    l2cb.rcv_pending_q = list_new(
# 852 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                 ((void *)0)
# 852 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                     );
    if (l2cb.rcv_pending_q == 
# 853 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                             ((void *)0)
# 853 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                 ) {
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unable to allocate memory for link layer control block" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };} while(0);
    }
}
...
void l2c_free(void)
{
    ...
    l2cb.rcv_pending_q = 
# 861 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                        ((void *)0)
# 861 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                            ;
}
# 873 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
void l2c_process_timeout (TIMER_LIST_ENT *p_tle)
{
    ...
    case 2:
        ...
        break;
# 889 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
    case 4:

        l2c_process_held_packets(
# 891 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c" 3 4
                                1
# 891 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/l2cap/l2c_main.c"
                                    );
        break;
