# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_event.h" 1
# 22 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/include/sdkconfig.h" 1
# 32 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 2


static const char* TAG = "event";
static 
# 35 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
      _Bool 
# 35 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
           s_event_init_flag = 
# 35 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                               0
# 35 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
...
# 36 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                                    ((void *)0)
# 36 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                                        ;
static system_event_cb_t s_event_handler_cb = 
# 37 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                                             ((void *)0)
# 37 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                                                 ;
static void *s_event_ctx = 
# 38 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                          ((void *)0)
# 38 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                              ;
...
static void esp_event_loop_task(void *pvParameters)
{
    while (1) {
        ...
        if (xQueueGenericReceive( ( s_event_queue ), ( &evt ), ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) ) == ( ( ( BaseType_t ) 1 ) )) {
            ...
            if (ret != 0) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "default event handler failed!" "\033[0m" "\n", esp_log_timestamp(), TAG); };
            }
            ret = esp_event_post_to_user(&evt);
            if (ret != 0) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "post event to user fail!" "\033[0m" "\n", esp_log_timestamp(), TAG); };
            }
        }
    }
}
...
{
    if (s_event_queue == 
# 75 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                        ((void *)0)
# 75 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                            ) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Event loop not initialized via esp_event_loop_init, but esp_event_send called" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return 0x103;
    }
    int ret = xQueueGenericSend( ( s_event_queue ), ( event ), ( 0 ), ( ( BaseType_t ) 0 ) );
    if (ret != ( ( ( BaseType_t ) 1 ) )) {
        if (event) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "e=%d f" "\033[0m" "\n", esp_log_timestamp(), TAG, event->event_id); };
        } else {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "e null" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        }
        return -1;
    }
    return 0;
...
esp_err_t esp_event_loop_init(system_event_cb_t cb, void *ctx)
{
    ...
    xTaskCreatePinnedToCore(esp_event_loop_task, "eventTask",
            8192, 
# 106 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                                  ((void *)0)
# 106 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                                      , ((( 25 )) - 5), 
# 106 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                                                              ((void *)0)
# 106 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
    ...
    s_event_init_flag = 
# 108 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c" 3 4
                       1
# 108 "/Users/Sentaro/esp/esp-idf/components/esp32/./event_loop.c"
                           ;
    return 0;
}
