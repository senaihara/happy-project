...
getMaxWidthHeight:
.LFB50:
	.file 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/components/tft/./tft.c"
	.loc 1 1384 0
	entry	sp, 32
.LCFI0:
.LVL0:
...
.LVL699:
	...
	l16ui	a11, a3, 0
	blt	a5, a11, .L298
	.loc 1 2329 0 is_stmt 0 discriminator 2
	l16ui	a12, a3, 2
	blt	a4, a12, .L299
...
.LVL718:
	...
	bge	a5, a8, .L294
	.loc 1 2349 0 is_stmt 1 discriminator 2
	addi.n	a2, a2, 1
.LVL719:
.L287:
...
.LVL1496:
	...
	call8	printf
.LVL1497:
	.loc 1 2380 0 is_stmt 1 discriminator 1
	movi.n	a5, 0
.LVL1498:
	j	.L559
.LVL1499:
...
.LVL1540:
	...
	l8ui	a7, a7, 0
	beqz.n	a7, .L575
	.loc 1 2462 0 is_stmt 0 discriminator 1
	mov.n	a11, a4
	l32r	a10, .LC228
	call8	printf
.LVL1541:
...
.LVL1592:
	bne	a3, a2, .L640
	.loc 1 2539 0 is_stmt 0 discriminator 2
	l8ui	a3, sp, 113
	movi.n	a2, 0x4d
	bne	a3, a2, .L641
...
.LVL1662:
.L618:
	.loc 1 2668 0 is_stmt 1 discriminator 1
	movi.n	a9, 0
	j	.L619
.LVL1663:
.L620:
...
.L627:
	...
	blt	a10, a2, .L628
.LBE50:
	.loc 1 2727 0 is_stmt 1 discriminator 2
	addi.n	a13, a13, 1
.LVL1686:
.L626:
	...
	blt	a13, a7, .L629
.LBE49:
	.loc 1 2739 0 is_stmt 1 discriminator 2
	movi	a4, 0xc8
	addi	a10, sp, 32
	add.n	a4, a10, a4
	l32i	a11, sp, 288
...
.Letext0:
	...
	.file 15 "/Users/Sentaro/GitHub/happy-project/walker_radar/components/spidriver/./spi_master_lobo.h"
	.file 16 "/Users/Sentaro/GitHub/happy-project/walker_radar/components/tft/./tftspi.h"
	.file 17 "/Users/Sentaro/esp/esp-idf/components/esp32/include/rom/tjpgd.h"
	.file 18 "/Users/Sentaro/GitHub/happy-project/walker_radar/components/tft/./tft.h"
...
.LASF1017:
	.string	"/Users/Sentaro/GitHub/happy-project/walker_radar/components/tft/./tft.c"
.LASF100:
	.string	"_flags2"
.LASF178:
	.string	"flash_rdid"
