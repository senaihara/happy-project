# 1 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/heap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
...
# 17 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_private.h" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_private.h" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_private.h" 2
...
# 15 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/heap/include/esp_heap_caps_init.h"
void heap_caps_init();
...
# 22 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 2
...
static void register_heap(heap_t *region)
{
    ...
    if (region->heap != 
# 35 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                       ((void *)0)
# 35 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                           ) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "New heap initialised at %p" "\033[0m" "\n", esp_log_timestamp(), TAG, region->heap); };
    }
}
...
void heap_caps_enable_nonos_stack_heaps()
{
    ...
    for ((heap) = (((&registered_heaps))->slh_first); (heap); (heap) = (((heap))->next.sle_next)) {
        ...
        if (heap->heap == 
# 46 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                         ((void *)0)
# 46 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                             ) {
            register_heap(heap);
            if (heap->heap != 
# 48 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                             ((void *)0)
# 48 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                                 ) {
...
static void disable_mem_region(soc_memory_region_t *regions, intptr_t from, intptr_t to)
{
    ...
    for (int i = 0; i < soc_memory_region_count; i++) {
        ...
        if (regStart >= from && regEnd <= to) {
            ...
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "region %d: hole punching is not supported!" "\033[0m" "\n", esp_log_timestamp(), TAG, i); };
            regions->type = -1;
        }
    }
}
...
void heap_caps_init()
{
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Initializing. RAM available for dynamic allocation:" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    for (int i = 0; i < soc_memory_region_count; i++) {
        soc_memory_region_t *region = &regions[i];
        ...
        heap_idx++;
        ((heap_idx <= num_heaps) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c", 156, __func__, "heap_idx <= num_heaps"));
        ...
        if (type->startup_stack) {
            ...
            heap->heap = 
# 164 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                        ((void *)0)
# 164 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                            ;
        } else {
            register_heap(heap);
        }
        ((heap)->next.sle_next) = 
# 168 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                                ((void *)0)
# 168 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                                    ;

        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "At %08X len %08X (%d KiB): %s" "\033[0m" "\n", esp_log_timestamp(), TAG, region->start, region->size, region->size / 1024, type->name); }
                                                                                    ;
    }

    ((heap_idx == num_heaps) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c", 174, __func__, "heap_idx == num_heaps"));




    ((((&registered_heaps)->slh_first == 
# 179 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
   ((void *)0)
# 179 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
   )) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c", 179, __func__, "SLIST_EMPTY(&registered_heaps)"));

    heap_t *heaps_array = 
# 181 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                         ((void *)0)
# 181 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                             ;
    for (int i = 0; i < num_heaps; i++) {
        if (heap_caps_match(&temp_heaps[i], (1<<2))) {

            heaps_array = multi_heap_malloc(temp_heaps[i].heap, sizeof(heap_t) * num_heaps);
            if (heaps_array != 
# 186 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                              ((void *)0)
# 186 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                                  ) {
                break;
            }
        }
    ...
    ((heaps_array != 
# 191 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
   ((void *)0)
# 191 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
   ) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c", 191, __func__, "heaps_array != NULL"));
...
# 197 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                                  ((void *)0)
# 197 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                                      ) {
...
esp_err_t heap_caps_add_region_with_caps(const uint32_t caps[], intptr_t start, intptr_t end)
{
    esp_err_t err = -1;
    if (caps == 
# 228 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
               ((void *)0) 
# 228 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
    ...
    if (p_new == 
# 233 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                ((void *)0)
# 233 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                    ) {
        err = 0x101;
        goto done;
    }
    ...
    ((p_new)->next.sle_next) = 
# 242 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                             ((void *)0)
# 242 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                                 ;
    if (p_new->heap == 
# 243 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c" 3 4
                      ((void *)0)
# 243 "/Users/Sentaro/esp/esp-idf/components/heap/./heap_caps_init.c"
                          ) {
        err = -1;
        goto done;
    }
