# 1 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/app_trace//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 2
# 27 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
esp_err_t esp_apptrace_tmo_check(esp_apptrace_tmo_t *tmo)
{
    if (tmo->tmo != ((uint32_t)-1)) {
        unsigned cur = xthal_get_ccount();
        if (tmo->start <= cur) {
            tmo->elapsed = ((cur - tmo->start)/((240 * 1000000)/1000000));
        } else {
            tmo->elapsed = ((0xFFFFFFFF - tmo->start + cur)/((240 * 1000000)/1000000));
        }
...
# 57 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
       _Bool 
# 57 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
...
uint8_t *esp_apptrace_rb_produce(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->wr + size >= rb->size) {
            if (rb->rd == 0) {
                return 
# 95 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
                      ((void *)0)
# 95 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
                          ;
            }
            if (rb->wr + size == rb->size) {
                rb->wr = 0;
                ...
                if (size > rb->rd - 1) {
                    return 
# 102 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
                          ((void *)0)
# 102 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
                              ;
                }
        ...
        if (size > rb->rd - rb->wr - 1) {
            return 
# 122 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
                  ((void *)0)
# 122 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
                      ;
        }
        rb->wr += size;
    }
...
uint8_t *esp_apptrace_rb_consume(esp_apptrace_rb_t *rb, uint32_t size)
{
    ...
    if (rb->rd <= rb->wr) {
        ...
        if (rb->rd + size > rb->wr) {
            return 
# 135 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
                  ((void *)0)
# 135 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
                      ;
        }
        rb->rd += size;
    } else {
        ...
        if (rb->rd + size > rb->cur_size) {
            return 
# 141 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c" 3 4
                  ((void *)0)
# 141 "/Users/Sentaro/esp/esp-idf/components/app_trace/./app_trace_util.c"
                      ;
