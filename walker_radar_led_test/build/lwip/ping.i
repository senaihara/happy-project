# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/lwip//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
# 41 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 42 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2



# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.h" 1
# 46 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.h"
void ping_init(void);
# 46 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 48 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 1
# 39 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h"
...
# 40 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 2
...
# 41 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/raw.h" 2
...
# 49 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 50 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 52 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 53 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 54 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
...
# 57 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2




# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/esp_ping.h" 1
# 31 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
...
# 62 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_set_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len);
# 75 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_get_target(ping_target_id_t opt_id, void *opt_val, uint32_t opt_len);
# 88 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/esp_ping.h"
esp_err_t esp_ping_result(uint8_t res_val, uint16_t res_len, uint32_t res_time);
# 62 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 2
# 102 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
ping_send(int s, ip_addr_t *addr)
{
  ...
  do { if(!(ping_size <= 0xffff)) __assert_func("/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c", 139, __func__, "ping_size is too big"); } while(0);
  do { if(!(!(((addr) != 
# 140 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
 ((void *)0)
# 140 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
 ) && (((&*(addr))->type) == 6U)))) __assert_func("/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c", 140, __func__, "ping: expect IPv4 address"); } while(0);
  ...
  while((len = lwip_recvfrom(s, buf, sizeof(buf), 0, (struct sockaddr*)&from, (socklen_t*)&fromlen)) > 0) {
    if (len >= (int)(sizeof(struct ip_hdr)+sizeof(struct icmp_echo_hdr))) {
      if (from.sin_family != 2) {
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: invalid sin_family\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      } else {
        ip4_addr_t fromaddr;
        (((&fromaddr)->addr = ((&from.sin_addr)->s_addr)));
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: recv ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", (&fromaddr) != 
# 179 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
       ((void *)0) 
# 179 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 179 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
       ((void *)0) 
# 179 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
       ? ((u16_t)(((const u8_t*)(&(&fromaddr)->addr))[3])) : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf (" %""d"" ms\n", (sys_now() - ping_time));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        if ((iecho->id == 0xAFAF) && (iecho->seqno == lwip_htons(ping_seq_num))) {
          ...
          esp_ping_result((((iecho)->type) == 0), len, (sys_now() - ping_time));



          return;
        } else {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: drop\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        }
      }
    }
    fromlen = sizeof(from);
  ...
  if (len == 0) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: recv - %""d"" ms - timeout\n", (sys_now()-ping_time));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  }
...
ping_thread(void *arg)
{
  ...
  if ((s = lwip_socket(2, 3, 1)) < 0) {
    return;
  }

  ret = lwip_setsockopt(s, 0xfff, 0x1006, &timeout, sizeof(timeout));
  do { if(!(ret == 0)) __assert_func("/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c", 232, __func__, "setting receive timeout failed"); } while(0);
  (void)ret;
  ...
  while (1) {
    ...
    if (ping_send(s, &ping_target) == 0) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: send ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      do { if((((&ping_target) != 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0)
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ) && (((&*(&ping_target))->type) == 6U))) { do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x", ((&((&ping_target)->u_addr.ip6))) != 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ? ((u16_t)(lwip_htonl(((&((&ping_target)->u_addr.ip6)))->addr[3])) & 0xffff) : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0); } else { do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "d" ".%" "d" ".%" "d" ".%" "d", ((&((&ping_target)->u_addr.ip4))) != 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 246 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ? ((u16_t)(((const u8_t*)(&((&((&ping_target)->u_addr.ip4)))->addr))[3])) : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0); }}while(0);
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ping: send ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      do { if((((&ping_target) != 
# 253 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0)
# 253 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ) && (((&*(&ping_target))->type) == 6U))) { do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x" ":%" "x", ((&((&ping_target)->u_addr.ip6))) != 
# 253 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
     ((void *)0) 
# 253 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
...
# 253 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
     ? ((u16_t)(((const u8_t*)(&((&((&ping_target)->u_addr.ip4)))->addr))[3])) : 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0); }}while(0);
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf (" - error\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    }
    sys_msleep(1000);
  }
}
# 356 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
void
ping_init(void)
{

  sys_thread_new("ping_thread", ping_thread, 
# 360 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c" 3 4
                                            ((void *)0)
# 360 "/Users/Sentaro/esp/esp-idf/components/lwip/apps/ping/ping.c"
                                                , 2560, ((( 25 )) - 7));
