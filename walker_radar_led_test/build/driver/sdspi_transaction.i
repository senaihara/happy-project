# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_private.h" 2
...
# 25 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 2

static const char* TAG = "sdspi_transaction";

static _lock_t s_lock;
static 
# 30 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 3 4
      _Bool 
# 30 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
           s_app_cmd;

static uint8_t sdspi_msg_crc7(sdspi_hw_cmd_t* hw_cmd)
{
    const size_t bytes_to_crc = 
# 34 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 3 4
                               __builtin_offsetof (
# 34 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
                               sdspi_hw_cmd_t
# 34 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 3 4
                               , 
# 34 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
...
esp_err_t sdspi_host_do_transaction(int slot, sdmmc_command_t *cmdinfo)
{
    ...
    if (ret == 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_VERBOSE) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "r1 = 0x%02x hw_cmd.r[0]=0x%08x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1, hw_cmd.response[0]); };

        if (flags & (1UL << (2))) {
            cmdinfo->response[0] = hw_cmd.r1;
            if (hw_cmd.r1 == 0xff) {

            } else if (hw_cmd.r1 & (1<<3)) {
                ret = 0x109;
            } else if (hw_cmd.r1 & (1<<0)) {

            } else if (hw_cmd.r1 != 0) {
                if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "Unexpected R1 response: 0x%02x" "\033[0m" "\n", esp_log_timestamp(), TAG, hw_cmd.r1); };
            }
        } else if (flags & (1UL << (3))) {
    ...
    if (ret == 0) {
        ...
        s_app_cmd = 
# 118 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c" 3 4
                   0
# 118 "/Users/Sentaro/esp/esp-idf/components/driver/./sdspi_transaction.c"
                        ;
    }
