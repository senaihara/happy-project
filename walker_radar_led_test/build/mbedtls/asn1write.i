# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 2
...
mbedtls_asn1_named_data *mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        ...
                                        size_t val_len );
# 31 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 2
...
int mbedtls_asn1_write_mpi( unsigned char **p, unsigned char *start, const mbedtls_mpi *X )
{
    ...
    (*p) -= len;
    do { if( ( ret = mbedtls_mpi_write_binary( X, *p, len ) ) != 0 ) goto cleanup; } while( 0 );
    ...
    do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x02 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
...
int mbedtls_asn1_write_null( unsigned char **p, unsigned char *start )
{
    ...
    do { if( ( ret = mbedtls_asn1_write_len( p, start, 0) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x05 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                    ...
                    const char *oid, size_t oid_len )
{
    ...
    do { if( ( ret = mbedtls_asn1_write_raw_buffer( p, start, (const unsigned char *) oid, oid_len ) ) < 0 ) return( ret ); else len += ret; } while( 0 )
                                                                          ;
    do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                                     ...
                                     size_t par_len )
{
    ...
    if( par_len == 0 )
        do { if( ( ret = mbedtls_asn1_write_null( p, start ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    else
        len += par_len;
...
int mbedtls_asn1_write_bool( unsigned char **p, unsigned char *start, int boolean )
{
    ...
    *--(*p) = (boolean) ? 255 : 0;
    ...
    do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x01 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                                 ...
                                 const char *text, size_t text_len )
{
    ...
    do { if( ( ret = mbedtls_asn1_write_raw_buffer( p, start, (const unsigned char *) text, text_len ) ) < 0 ) return( ret ); else len += ret; } while( 0 )
                                                            ;

    do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x13 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                           ...
                           const char *text, size_t text_len )
{
    ...
    do { if( ( ret = mbedtls_asn1_write_len( p, start, len ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
    do { if( ( ret = mbedtls_asn1_write_tag( p, start, 0x16 ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                             ...
                             const unsigned char *buf, size_t size )
{
    ...
    do { if( ( ret = mbedtls_asn1_write_raw_buffer( p, start, buf, size ) ) < 0 ) return( ret ); else len += ret; } while( 0 );
                                        ...
                                        size_t val_len )
{
    ...
    if( ( cur = mbedtls_asn1_find_named_data( *head, oid, oid_len ) ) == 
# 338 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                                                                        ((void *)0) 
# 338 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                                                                             )
    {
        ...
        if( cur == 
# 344 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                  ((void *)0) 
# 344 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                       )
            return( 
# 345 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                   ((void *)0) 
# 345 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                        );

        cur->oid.len = oid_len;
        cur->oid.p = calloc( 1, oid_len );
        if( cur->oid.p == 
# 349 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                         ((void *)0) 
# 349 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                              )
        {
            free( cur );
            return( 
# 352 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                   ((void *)0) 
# 352 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                        );
        }
        ...
        cur->val.len = val_len;
        cur->val.p = calloc( 1, val_len );
        if( cur->val.p == 
# 359 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                         ((void *)0) 
# 359 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                              )
        {
            free( cur->oid.p );
            free( cur );
            return( 
# 363 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                   ((void *)0) 
# 363 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                        );
        }
    ...
    else if( cur->val.len < val_len )
    {
        ...
        if( p == 
# 377 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                ((void *)0) 
# 377 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                     )
            return( 
# 378 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
                   ((void *)0) 
# 378 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                        );
    ...
    if( val != 
# 385 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c" 3 4
              ((void *)0) 
# 385 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1write.c"
                   )
