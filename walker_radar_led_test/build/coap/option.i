# 1 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
# 11 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
...
# 12 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 2
...
options_start(coap_pdu_t *pdu) {
  ...
  if (pdu && pdu->hdr &&
    ...
    return (*opt == 0xFF) ? 
# 32 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
                                         ((void *)0) 
# 32 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
                                              : opt;

  } else
    return 
# 35 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 35 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
              ;
}
...
coap_opt_parse(const coap_opt_t *opt, size_t length, coap_option_t *result) {
  ...
  ((opt) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 43, __func__, "opt")); ((result) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 43, __func__, "result"));
# 53 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
  if (length < 1)
    return 0;
...
coap_option_iterator_init(coap_pdu_t *pdu, coap_opt_iterator_t *oi,
     const coap_opt_filter_t filter) {
  ((pdu) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 122, __func__, "pdu"));
  ((pdu->hdr) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 123, __func__, "pdu->hdr"));
  ((oi) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 124, __func__, "oi"));
  ...
  if ((unsigned char *)pdu->hdr + pdu->length <= oi->next_option) {
    oi->bad = 1;
    return 
# 132 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 132 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
              ;
  }

  (((sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 135, __func__, "(sizeof(coap_hdr_t) + pdu->hdr->token_length) <= pdu->length"));
...
opt_finished(coap_opt_iterator_t *oi) {
  ((oi) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 148, __func__, "oi"));
...
# 161 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
                           ((void *)0)
# 161 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
                               ;
  size_t optsize;
  int b;

  ((oi) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 165, __func__, "oi"));

  if (opt_finished(oi))
    return 
# 168 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
          ((void *)0)
# 168 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
              ;
  ...
  while (1) {
    ...
    if (optsize) {
      ((optsize <= oi->length) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 180, __func__, "optsize <= oi->length"));
      ...
      oi->bad = 1;
      return 
# 188 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 188 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
                ;
    }
 ...
 (b = coap_option_getb(oi->filter, oi->type)) > 0)
      ...
      oi->bad = 1;
      return 
# 201 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c" 3 4
            ((void *)0)
# 201 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
                ;
    }
  }
...
coap_opt_setheader(coap_opt_t *opt, size_t maxlen,
  ...
  ((opt) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 333, __func__, "opt"));
...
coap_opt_encode(coap_opt_t *opt, size_t maxlen, unsigned short delta,
  ...
  ((l <= maxlen) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c", 389, __func__, "l <= maxlen"));
...
# 448 "/Users/Sentaro/esp/esp-idf/components/coap/libcoap/src/option.c"
static int
