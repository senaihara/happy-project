# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
# 34 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 35 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 2
...
{
# 64 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
}
# 78 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
...
# 95 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void leftshift_onebit(UINT8 *input, UINT8 *output)
{
    UINT8 i, overflow = 0 , next_overflow = 0;
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "leftshift_onebit " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
...
# 116 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_aes_cleanup(void)
{
    if (cmac_cb.text != 
# 118 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                       ((void *)0)
# 118 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                           ) {
        free((cmac_cb.text));
    }
    memset(&cmac_cb, 0, sizeof(tCMAC_CB));
}
# 133 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_aes_k_calculate(BT_OCTET16 key, UINT8 *p_signature, UINT16 tlen)
{
    ...
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "cmac_aes_k_calculate " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    ...
    if (!err) {
        ...
        {if (smp_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "tlen = %d p_mac = %p" "\033[0m" "\n", esp_log_timestamp(), "BT", tlen, p_mac); };};
        {if (smp_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "p_mac[0] = 0x%02x p_mac[1] = 0x%02x p_mac[2] = 0x%02x p_mac[3] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT", *p_mac, *(p_mac + 1), *(p_mac + 2), *(p_mac + 3)); };}
                                                                         ;
        {if (smp_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "p_mac[4] = 0x%02x p_mac[5] = 0x%02x p_mac[6] = 0x%02x p_mac[7] = 0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT", *(p_mac + 4), *(p_mac + 5), *(p_mac + 6), *(p_mac + 7)); };}
                                                                               ;

        return 
# 164 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
              1
# 164 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;

    } else {
        return 
# 167 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
              0
# 167 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                   ;
    }
}
# 180 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_prepare_last_block (BT_OCTET16 k1, BT_OCTET16 k2)
{

    BOOLEAN flag;

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "cmac_prepare_last_block " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    flag = ((cmac_cb.len % 16) == 0 && cmac_cb.len != 0) ? 
# 187 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                       1 
# 187 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                                                                            : 
# 187 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                                              0
# 187 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
    ...
    {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "flag = %d round = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", flag, cmac_cb.round); };};
...
# 209 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static void cmac_subkey_cont(tSMP_ENC *p)
{
    UINT8 k1[16], k2[16];
    UINT8 *pp = p->param_buf;
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "cmac_subkey_cont " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
...
# 250 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
static BOOLEAN cmac_generate_subkey(BT_OCTET16 key)
{
    BT_OCTET16 z = {0};
    BOOLEAN ret = 
# 253 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                     1
# 253 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                         ;
    tSMP_ENC output;
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " " cmac_generate_subkey" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    if (SMP_Encrypt(key, 16, z, 16, &output)) {
        cmac_subkey_cont(&output);;
    } else {
        ret = 
# 260 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 260 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;
    }

    return ret;
}
# 280 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                                 ...
                                 UINT16 tlen, UINT8 *p_signature)
{
    ...
    BOOLEAN ret = 
# 285 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                 0
# 285 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                      ;
    ...
    {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "AES128_CMAC started, allocate buffer size = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", len); };};

    if ((cmac_cb.text = (UINT8 *)malloc((len))) != 
# 296 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                                                    ((void *)0)
# 296 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                                                        ) {
        cmac_cb.round = n;
        ...
        if (input != 
# 302 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
                    ((void *)0) 
# 302 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                         && length > 0) {
        ...
        ret = 
# 317 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c" 3 4
             0
# 317 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_cmac.c"
                  ;
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "No resources" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    }
