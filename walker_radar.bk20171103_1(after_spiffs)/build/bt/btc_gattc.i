# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gattc.h" 1
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gattc.h"
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gattc.h" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gattc.h" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gattc.h" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 28 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h"
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/include/bt_trace.h" 1
# 23 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 2
...
void btc_gattc_arg_deep_copy(btc_msg_t *msg, void *p_dest, void *p_src)
{
    ...
    case BTC_GATTC_ACT_WRITE_CHAR: {
        dst->write_char.value = (uint8_t *)malloc((src->write_char.value_len));
    ...
    case BTC_GATTC_ACT_WRITE_CHAR_DESCR: {
        dst->write_descr.value = (uint8_t *)malloc((src->write_descr.value_len));
    ...
    case BTC_GATTC_ACT_PREPARE_WRITE: {
        dst->prep_write.value = (uint8_t *)malloc((src->prep_write.value_len));
    ...
    case BTC_GATTC_ACT_PREPARE_WRITE_CHAR_DESCR: {
        dst->prep_write_descr.value = (uint8_t *)malloc((src->prep_write_descr.value_len));
...
void btc_gattc_arg_deep_free(btc_msg_t *msg)
{
    ...
    case BTC_GATTC_ACT_WRITE_CHAR: {
        if (arg->write_char.value) {
            free((arg->write_char.value));
        }
        break;
    }
    case BTC_GATTC_ACT_WRITE_CHAR_DESCR: {
        if (arg->write_descr.value) {
            free((arg->write_descr.value));
        }
        break;
    }
    case BTC_GATTC_ACT_PREPARE_WRITE: {
        if (arg->prep_write.value) {
            free((arg->prep_write.value));
        }
        break;
    }
    case BTC_GATTC_ACT_PREPARE_WRITE_CHAR_DESCR: {
        if (arg->prep_write_descr.value) {
            free((arg->prep_write_descr.value));
        }
        break;
    }
    default:
...
static void btc_gattc_cback(tBTA_GATTC_EVT event, tBTA_GATTC *p_data)
{
    ...
    if (ret) {
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s transfer failed\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };} while(0);
    }
}
...
static void btc_gattc_search_service(btc_ble_gattc_args_t *arg)
{
    ...
    if (arg->search_srvc.filter_uuid_enable) {
        ...
        BTA_GATTC_ServiceSearchRequest(arg->search_srvc.conn_id, 
# 195 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                ((void *)0)
# 195 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                    );
    }
}
...
static void btc_gattc_get_first_char(btc_ble_gattc_args_t *arg)
{
    ...
    status = BTA_GATTC_GetFirstChar(arg->get_first_char.conn_id, &srvc_id, 
# 210 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                          ((void *)0)
# 210 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                              ,
    ...
    gattc_if = ((uint8_t)(arg->get_first_char.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_char.conn_id = (((uint16_t)(arg->get_first_char.conn_id)) >> 8);
...
static void btc_gattc_get_next_char(btc_ble_gattc_args_t *arg)
{
    ...
    status = BTA_GATTC_GetNextChar(arg->get_next_char.conn_id, &in_char_id, 
# 239 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                           ((void *)0)
# 239 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                               ,
                                   &out_char_id, &out_char_prop);
    ...
    gattc_if = ((uint8_t)(arg->get_next_char.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_char.conn_id = (((uint16_t)(arg->get_next_char.conn_id)) >> 8);
    param.get_char.status = status;
...
static void btc_gattc_get_first_descr(btc_ble_gattc_args_t *arg)
{
    ...
    status = BTA_GATTC_GetFirstCharDescr(arg->get_first_descr.conn_id, &in_char_id, 
# 268 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                                   ((void *)0)
# 268 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                                       ,
                                         &out_char_descr_id);
    ...
    gattc_if = ((uint8_t)(arg->get_first_descr.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_descr.conn_id = (((uint16_t)(arg->get_first_descr.conn_id)) >> 8);
...
static void btc_gattc_get_next_descr(btc_ble_gattc_args_t *arg)
{
    ...
    status = BTA_GATTC_GetNextCharDescr(arg->get_next_descr.conn_id, &in_char_descr_id
                                        , 
# 299 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                         ((void *)0)
# 299 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                             , &out_char_descr_id);
    if (status == 0) {
        bta_to_btc_gatt_id(&descr_id, &out_char_descr_id.descr_id);
    }

    gattc_if = ((uint8_t)(arg->get_next_descr.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_descr.conn_id = (((uint16_t)(arg->get_next_descr.conn_id)) >> 8);
    param.get_descr.status = status;
...
# 326 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
            ((void *)0)
# 326 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                , &out_incl_svc_id);

    bta_to_btc_srvc_id(&incl_srvc_id, &out_incl_svc_id.incl_svc_id);

    gattc_if = ((uint8_t)(arg->get_first_incl_srvc.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_incl_srvc.conn_id = (((uint16_t)(arg->get_first_incl_srvc.conn_id)) >> 8);
...
# 352 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
            ((void *)0)
# 352 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                , &out_incl_svc_id);

    bta_to_btc_srvc_id(&incl_srvc_id, &out_incl_svc_id.incl_svc_id);

    gattc_if = ((uint8_t)(arg->get_next_incl_srvc.conn_id));
    memset(&param, 0, sizeof(esp_ble_gattc_cb_param_t));
    param.get_incl_srvc.conn_id = (((uint16_t)(arg->get_next_incl_srvc.conn_id)) >> 8);
    param.get_incl_srvc.status = status;
...
void btc_gattc_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_GATTC_ACT_CACHE_REFRESH:
        ...
        break;
    default:
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unhandled event (%d)!\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, msg->act); };} while(0);
        break;
    }
...
void btc_gattc_cb_handler(btc_msg_t *msg)
{
    ...
    case 1: {
        ...
        gattc_if = reg_oper->client_if;
        btc_gattc_cb_to_app(ESP_GATTC_UNREG_EVT, gattc_if, 
# 588 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                          ((void *)0)
# 588 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                              );
        break;
    }
    case 3: {
    ...
    case 11: {
        ...
        uint32_t ret_evt = (msg->act == 4) ?
                           ESP_GATTC_WRITE_CHAR_EVT : ESP_GATTC_PREP_WRITE_EVT;

        gattc_if = ((uint8_t)(write->conn_id));
        param.write.conn_id = (((uint16_t)(write->conn_id)) >> 8);
    ...
    case 12: {
        ...
        gattc_if = ((uint8_t)(exec_cmpl->conn_id));
        param.exec_cmpl.conn_id = (((uint16_t)(exec_cmpl->conn_id)) >> 8);
    ...
    case 6: {
        ...
        gattc_if = ((uint8_t)(search_cmpl->conn_id));
        param.search_cmpl.conn_id = (((uint16_t)(search_cmpl->conn_id)) >> 8);
    ...
    case 7: {
        ...
        gattc_if = ((uint8_t)(srvc_res->conn_id));
        param.search_res.conn_id = (((uint16_t)(srvc_res->conn_id)) >> 8);
    ...
    case 10: {
        ...
        gattc_if = ((uint8_t)(notify->conn_id));
        param.notify.conn_id = (((uint16_t)(notify->conn_id)) >> 8);
        ...
        param.notify.is_notify = (notify->is_notify == 
# 665 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                      1
# 665 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                          ) ? 
# 665 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                              1 
# 665 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 665 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                                          ;
        param.notify.value_len = (notify->len > 600) ?
                                 600 : notify->len;
        param.notify.value = notify->value;

        if (notify->is_notify == 
# 670 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                0
# 670 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                     ) {
    ...
    case 2: {
        ...
        param.open.conn_id = (((uint16_t)(open->conn_id)) >> 8);
    ...
    case 35: {
        ...
        param.connect.conn_id = (((uint16_t)(connect->conn_id)) >> 8);
    ...
    case 5: {
        ...
        param.close.conn_id = (((uint16_t)(close->conn_id)) >> 8);
    ...
    case 36: {
        ...
        param.disconnect.conn_id = (((uint16_t)(disconnect->conn_id)) >> 8);
    ...
    case 18: {
        ...
        gattc_if = ((uint8_t)(cfg_mtu->conn_id));
        param.cfg_mtu.conn_id = (((uint16_t)(cfg_mtu->conn_id)) >> 8);
    ...
    case 24: {
        ...
        gattc_if = ((uint8_t)(congest->conn_id));
        param.congest.conn_id = (((uint16_t)(congest->conn_id)) >> 8);
        param.congest.congested = (congest->congested == 
# 743 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                        1
# 743 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
                                                            ) ? 
# 743 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c" 3 4
                                                                1 
# 743 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
...
# 743 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gattc.c"
    ...
    case 15: {
        ...
        btc_gattc_cb_to_app(ESP_GATTC_SRVC_CHG_EVT, 0xff, &param);
        break;
    }
    default:
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unhandled event (%d)!" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, msg->act); };} while(0);
        break;
    }
