...
ulp_run:
.LFB1:
	.file 1 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp.c"
	.loc 1 45 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.LFE2:
	...
	.align	4
.LC15:
	.string	"\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!(((((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t))) >= 0x3ff00000) && (((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t))) <= 0x3ff03FFC))"
	.align	4
.LC18:
	.string	"/Users/Sentaro/esp/esp-idf/components/ulp/./ulp.c"
	.align	4
.LC20:
	.string	"\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!((((((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t)))) >= 0x3ff00000) && ((((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t)))) <= 0x3ff03FFC))"
	.align	4
.LC22:
	.string	"\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!(((((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t))) >= 0x3ff00000) && (((0x3ff48800 + 0x0018) + period_index * sizeof(uint32_t))) <= 0x3ff03FFC))"
	.section	.text.ulp_set_wakeup_period,"ax",@progbits
	.literal_position
	.literal .LC13, 74246
	.literal .LC14, 16380
	.literal .LC16, .LC15
	.literal .LC17, __func__$3583
	.literal .LC19, .LC18
	.literal .LC21, .LC20
	.literal .LC23, .LC22
...
.Letext0:
	...
	.file 8 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_clk.h"
...
.LASF50:
	.string	"period_us"
.LASF61:
	.string	"/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/ulp"
.LASF4:
	.string	"__uint16_t"
.LASF54:
	.string	"memcpy"
