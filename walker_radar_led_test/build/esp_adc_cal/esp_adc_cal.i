# 1 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/esp_adc_cal//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/esp_adc_cal/./esp_adc_cal.c" 2
                                     ...
                                     esp_adc_cal_characteristics_t *chars)
{
    ...
    if (v_ref >= 1000) {
        chars->gain = ((chars->v_ref - 1000)
                      * chars->table->gain_m)
                      + chars->table->gain_c;
        chars->offset = (((chars->v_ref - 1000)
                        * chars->table->offset_m)
                        + chars->table->offset_c
                        + ((1 << 10) / 2))
                        >> 10;
        chars->ideal_offset = (((1100 - 1000)
                              * chars->table->offset_m)
                              + chars->table->offset_c
                              + ((1 << 10) / 2))
                              >> 10;
                                    ...
                                    const esp_adc_cal_characteristics_t *chars)
{
    ...
    uint32_t i = (adc >> chars->table->bit_shift);
