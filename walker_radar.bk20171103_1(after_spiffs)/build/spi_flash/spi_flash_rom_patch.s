...
.LFB11:
	.file 1 "/Users/Sentaro/esp/esp-idf/components/spi_flash/./spi_flash_rom_patch.c"
	.loc 1 310 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.LC41:
	...
	.string	"READ_PERI_REG)\" && (!((((((0x3ff42000 + (((1)>1) ? (((1)* 0x1000) + 0x20000) : (((~(1)) & 1)* 0x1000 ))) + 0x80) + i * 4)) >= 0x3ff00000) && ((((0x3ff42000 + (((1)>1) ? (((1)* 0x1000) + 0x20000) : (((~(1)) & 1)* 0x1000 ))) + 0x80) + i * 4)) <= 0x3ff03FFC))"
	.align	4
.LC44:
	.string	"/Users/Sentaro/esp/esp-idf/components/spi_flash/./spi_flash_rom_patch.c"
...
.LC54:
	...
	.string	"RITE_PERI_REG)\" && (!((((((0x3ff42000 + (((1)>1) ? (((1)* 0x1000) + 0x20000) : (((~(1)) & 1)* 0x1000 ))) + 0x80) + i * 4)) >= 0x3ff00000) && ((((0x3ff42000 + (((1)>1) ? (((1)* 0x1000) + 0x20000) : (((~(1)) & 1)* 0x1000 ))) + 0x80) + i * 4)) <= 0x3ff03FFC))"
...
.LFE20:
	...
	.section	.rodata.__func__$2509,"a",@progbits
	.align	4
	.type	__func__$2509, @object
	.size	__func__$2509, 27
__func__$2509:
	.string	"esp_rom_spiflash_read_data"
	.section	.rodata.__func__$2480,"a",@progbits
	.align	4
	.type	__func__$2480, @object
	.size	__func__$2480, 39
__func__$2480:
...
.Letext0:
	...
	.file 4 "/Users/Sentaro/esp/esp-idf/components/esp32/include/rom/spi_flash.h"
	.file 5 "/Users/Sentaro/esp/esp-idf/components/newlib/include/assert.h"
