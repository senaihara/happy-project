# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bootloader/bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
...
# 15 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
# 77 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
...
# 78 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 79 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2
...
# 80 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 2

static const char *TAG = "bootloader_flash";
# 91 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
static 
# 91 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
      _Bool 
# 91 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
           mapped;


static uint32_t current_read_mapping = 0xffffffffUL;

const void *bootloader_mmap(uint32_t src_addr, uint32_t size)
{
    if (mapped) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "tried to bootloader_mmap twice" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return 
# 100 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 100 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    if (size > 0x320000) {

        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_mmap excess size %x" "\033[0m" "\n", esp_log_timestamp(), TAG, size); };
        return 
# 105 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 105 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }

    uint32_t src_addr_aligned = src_addr & 0xffff0000;
    uint32_t count = (size + (src_addr - src_addr_aligned) + 0xffff) / 0x00010000;
    Cache_Read_Disable(0);
    Cache_Flush(0);
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "mmu set paddr=%08x count=%d" "\033[0m" "\n", esp_log_timestamp(), TAG, src_addr_aligned, count); };
    int e = cache_flash_mmu_set(0, 0, 0x3f400000, src_addr_aligned, 64, count);
    if (e != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "cache_flash_mmu_set failed: %d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, e); };
        Cache_Read_Enable(0);
        return 
# 117 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
              ((void *)0)
# 117 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                  ;
    }
    Cache_Read_Enable(0);

    mapped = 
# 121 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
            1
# 121 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                ;
...
void bootloader_munmap(const void *mapping)
{
    if (mapped) {
        ...
        mmu_init(0);
        mapped = 
# 133 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                0
# 133 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                     ;
        current_read_mapping = 0xffffffffUL;
    }
}
...
static esp_err_t bootloader_flash_read_allow_decrypt(size_t src_addr, void *dest, size_t size)
{
    ...
    for (int word = 0; word < size / 4; word++) {
        ...
        uint32_t map_at = word_src & 0xffff0000;
        uint32_t *map_ptr;
        if (map_at != current_read_mapping) {

            Cache_Read_Disable(0);
            Cache_Flush(0);
            if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "mmu set block paddr=0x%08x (was 0x%08x)" "\033[0m" "\n", esp_log_timestamp(), TAG, map_at, current_read_mapping); };
            int e = cache_flash_mmu_set(0, 0, 0x3f720000, map_at, 64, 1);
            if (e != 0) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "cache_flash_mmu_set failed: %d\n" "\033[0m" "\n", esp_log_timestamp(), TAG, e); };
                Cache_Read_Enable(0);
                return -1;
        ...
        map_ptr = (uint32_t *)(0x3f720000 + (word_src - map_at));
...
esp_err_t bootloader_flash_read(size_t src_addr, void *dest, size_t size, 
# 193 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                         _Bool 
# 193 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                              allow_decrypt)
{
    if (src_addr & 3) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_read src_addr 0x%x not 4-byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, src_addr); };
        return -1;
    }
    if (size & 3) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_read size 0x%x not 4-byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, size); };
        return -1;
    }
    if ((intptr_t)dest & 3) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_read dest 0x%x not 4-byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, (intptr_t)dest); };
        return -1;
    }
...
esp_err_t bootloader_flash_write(size_t dest_addr, void *src, size_t size, 
# 215 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c" 3 4
                                                                          _Bool 
# 215 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/bootloader_flash.c"
                                                                               write_encrypted)
{
    esp_err_t err;
    size_t alignment = write_encrypted ? 32 : 4;
    if ((dest_addr % alignment) != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_write dest_addr 0x%x not %d-byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, dest_addr, alignment); };
        return -1;
    }
    if ((size % alignment) != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_write size 0x%x not %d-byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, size, alignment); };
        return -1;
    }
    if (((intptr_t)src % 4) != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "bootloader_flash_write src 0x%x not 4 byte aligned" "\033[0m" "\n", esp_log_timestamp(), TAG, (intptr_t)src); };
        return -1;
    }
