...
void esp_efuse_burn_new_values(void)
{
    ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x0fc))) = (0x5A5A); });
    ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x104))) = (0x02); });
    while (({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x104))); }) != 0) {
    }
    ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x0fc))) = (0x5AA5); });
    ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x104))) = (0x01); });
    while (({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x104))); }) != 0) {
    }
    esp_efuse_reset();
}
...
void esp_efuse_disable_basic_rom_console(void)
{
    if ((({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x018))); }) & ((1UL << (2)))) == 0) {
        ...
        esp_efuse_reset();
        ({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x034))) = (((1UL << (2)))); });
