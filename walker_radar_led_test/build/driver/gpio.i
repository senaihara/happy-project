# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
...
# 15 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 2
...
# 80 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                       ((void *)0)
# 80 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                           ;
...
esp_err_t gpio_pullup_en(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 86, "GPIO number error"); }; return (0x102); };
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        rtc_gpio_pullup_en(gpio_num);
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)"); (("(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 90, __func__, "\"(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) |= (((1UL << (8))))); });
    }
    return 0;
}
...
esp_err_t gpio_pullup_dis(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 97, "GPIO number error"); }; return (0x102); };
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        rtc_gpio_pullup_dis(gpio_num);
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)"); (("(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 101, __func__, "\"(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) &= ~(((1UL << (8))))); });
    }
    return 0;
}
...
esp_err_t gpio_pulldown_en(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 108, "GPIO number error"); }; return (0x102); };
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        rtc_gpio_pulldown_en(gpio_num);
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)"); (("(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 112, __func__, "\"(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) |= (((1UL << (7))))); });
    }
    return 0;
}
...
esp_err_t gpio_pulldown_dis(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 119, "GPIO number error"); }; return (0x102); };
    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        rtc_gpio_pulldown_dis(gpio_num);
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)"); (("(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 123, __func__, "\"(Cannot use REG_CLR_BIT for DPORT registers use DPORT_REG_CLR_BIT)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t*)(GPIO_PIN_MUX_REG[gpio_num]) &= ~(((1UL << (7))))); });
    }
    return 0;
}
...
esp_err_t gpio_set_intr_type(gpio_num_t gpio_num, gpio_int_type_t intr_type)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 130, "GPIO number error"); }; return (0x102); };
    if (!(intr_type < GPIO_INTR_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 131, "GPIO interrupt type error"); }; return (0x102); };
...
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 138, "GPIO number error"); }; return (0x102); };
    if (core_id == 0) {
...
esp_err_t gpio_intr_disable(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 154, "GPIO number error"); }; return (0x102); };
...
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 161, "GPIO number error"); }; return (0x102); };
    if (gpio_num < 32) {
    ...
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff44000 + 0x0530) + (gpio_num * 4))) >= 0x3ff00000) && (((0x3ff44000 + 0x0530) + (gpio_num * 4))) <= 0x3ff03FFC)), (!(((((0x3ff44000 + 0x0530) + (gpio_num * 4))) >= 0x3ff00000) && (((0x3ff44000 + 0x0530) + (gpio_num * 4))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff44000 + 0x0530) + (gpio_num * 4))) >= 0x3ff00000) && (((0x3ff44000 + 0x0530) + (gpio_num * 4))) <= 0x3ff03FFC))) ? (void)0 : __assert_func (
 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
# 169 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
    ,
 170
# 169 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
    , __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff44000 + 0x0530) + (gpio_num * 4))) >= 0x3ff00000) && (((0x3ff44000 + 0x0530) + (gpio_num * 4))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff44000 + 0x0530) + (gpio_num * 4))) = (256); })
                               ;
...
{
    if (!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 177, "GPIO output gpio_num error"); }; return (0x102); };
    if (gpio_num < 32) {
...
# 183 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                               0
# 183 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                                    , 
# 183 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                                      0
# 183 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
...
esp_err_t gpio_set_level(gpio_num_t gpio_num, uint32_t level)
{
    if (!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 189, "GPIO output gpio_num error"); }; return (0x102); };
    if (level) {
        if (gpio_num < 32) {
...
esp_err_t gpio_set_pull_mode(gpio_num_t gpio_num, gpio_pull_mode_t pull)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 217, "GPIO number error"); }; return (0x102); };
    if (!(pull <= GPIO_FLOATING)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 218, "GPIO pull mode error"); }; return (0x102); };
    esp_err_t ret = 0;
    switch (pull) {
    ...
    case GPIO_FLOATING:
        ...
        break;
    default:
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown pull up/down mode,gpio_num=%u,pull=%u" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, gpio_num, pull); };
        ret = 0x102;
        break;
    }
    return ret;
...
esp_err_t gpio_set_direction(gpio_num_t gpio_num, gpio_mode_t mode)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 247, "GPIO number error"); }; return (0x102); };
    if (gpio_num >= 34 && (mode & ((0x00000002)))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "io_num=%d can only be input" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, gpio_num); };
        return 0x102;
    }
    esp_err_t ret = 0;
    if (mode & (0x00000001)) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)"); (("(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 254, __func__, "\"(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 254, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 254, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })|(((1UL << (9)))))); }); });
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)"); (("(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 256, __func__, "\"(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 256, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 256, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })&(~(((1UL << (9))))))); }); });
    }
    if (mode & (0x00000002)) {
...
esp_err_t gpio_config(const gpio_config_t *pGPIOConfig)
{
    ...
    if (pGPIOConfig->pin_bit_mask == 0 || pGPIOConfig->pin_bit_mask >= (((uint64_t) 1) << 40)) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "GPIO_PIN mask error " "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG); };
        return 0x102;
    }
    if ((pGPIOConfig->mode) & ((0x00000002))) {
        ...
        if ((gpio_pin_mask & ( ((uint64_t)(((uint64_t)1)<<34)) | ((uint64_t)(((uint64_t)1)<<35)) | ((uint64_t)(((uint64_t)1)<<36)) | ((uint64_t)(((uint64_t)1)<<37)) | ((uint64_t)(((uint64_t)1)<<38)) | ((uint64_t)(((uint64_t)1)<<39))))) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "GPIO34-39 can only be used as input mode" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG); };
            return 0x102;
        }
    }
    do {
        io_reg = GPIO_PIN_MUX_REG[io_num];
        if (((gpio_pin_mask >> io_num) & (1UL << (0))) && io_reg) {
            if(rtc_gpio_is_valid_gpio(io_num)){
                rtc_gpio_deinit(io_num);
            }
            if ((pGPIOConfig->mode) & (0x00000001)) {
                input_en = 1;
                ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)"); (("(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 300, __func__, "\"(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)\" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 300, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[io_num])))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 300, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[io_num]))); })|(((1UL << (9)))))); }); });
            } else {
                ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), 1), "(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)"); (("(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 302, __func__, "\"(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)\" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 302, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((GPIO_PIN_MUX_REG[io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[io_num]))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[io_num])))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 302, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[io_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[io_num]))); })&(~(((1UL << (9))))))); }); });
            }
            ...
            if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { esp_log_write(ESP_LOG_INFO, GPIO_TAG, "\033[0;" "32" "m" "I" " (%d) %s: " "GPIO[%d]| InputEn: %d| OutputEn: %d| OpenDrain: %d| Pullup: %d| Pulldown: %d| Intr:%d " "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, io_num, input_en, output_en, od_en, pu_en, pd_en, pGPIOConfig->intr_type); };
            ...
            ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC)), (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 335, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((io_reg))) >= 0x3ff00000) && (((io_reg))) <= 0x3ff03FFC)), (!(((((io_reg))) >= 0x3ff00000) && (((io_reg))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((io_reg))) >= 0x3ff00000) && (((io_reg))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 335, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((io_reg))) >= 0x3ff00000) && (((io_reg))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((io_reg))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC)), (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 335, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((io_reg)) >= 0x3ff00000) && ((io_reg)) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(io_reg)); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
        }
        io_num++;
    } while (io_num < 40);
    return 0;
...
void __attribute__((section(".iram1"))) gpio_intr_service(void* arg)
{
    ...
    if (gpio_isr_func == 
# 353 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                        ((void *)0)
# 353 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                            ) {
        return;
    }
    do {
...
# 359 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                                 ((void *)0)
# 359 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                                     ) {
            ...
            if (gpio_intr_status_h & (1UL << (gpio_num - 32))) {
                if (gpio_isr_func[gpio_num].fn != 
# 366 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                                 ((void *)0)
# 366 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                                     ) {
                    gpio_isr_func[gpio_num].fn(gpio_isr_func[gpio_num].args);
                }
...
{
    if (!(gpio_isr_func != 
# 377 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
   ((void *)0)
# 377 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
   )) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 377, "GPIO isr service is not installed, call gpio_install_isr_service() first"); }; return (0x103); };
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 378, "GPIO number error"); }; return (0x102); };
...
{
    if (!(gpio_isr_func != 
# 392 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
   ((void *)0)
# 392 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
   )) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 392, "GPIO isr service is not installed, call gpio_install_isr_service() first"); }; return (0x103); };
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 393, "GPIO number error"); }; return (0x102); };
    vTaskEnterCritical(&gpio_spinlock);
    gpio_intr_disable(gpio_num);
    if (gpio_isr_func) {
        gpio_isr_func[gpio_num].fn = 
# 397 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                    ((void *)0)
# 397 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                        ;
        gpio_isr_func[gpio_num].args = 
# 398 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                      ((void *)0)
# 398 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                                          ;
    }
    vTaskExitCritical(&gpio_spinlock);
    return 0;
...
{
    if (!(gpio_isr_func == 
# 406 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
   ((void *)0)
# 406 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
   )) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 406, "GPIO isr service already installed"); }; return (-1); };
    esp_err_t ret;
    vTaskEnterCritical(&gpio_spinlock);
    gpio_isr_func = (gpio_isr_func_t*) calloc(GPIO_NUM_MAX, sizeof(gpio_isr_func_t));
    if (gpio_isr_func == 
# 410 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                        ((void *)0)
# 410 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                            ) {
        ret = 0x101;
    } else {
        ret = gpio_isr_register(gpio_intr_service, 
# 413 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                                                  ((void *)0)
# 413 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
...
{
    if (gpio_isr_func == 
# 421 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                        ((void *)0)
# 421 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                            ) {
        return;
    }
    vTaskEnterCritical(&gpio_spinlock);
    ...
    free(gpio_isr_func);
    gpio_isr_func = 
# 427 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
                   ((void *)0)
# 427 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
                       ;
    vTaskExitCritical(&gpio_spinlock);
    return;
}
...
esp_err_t gpio_isr_register(void (*fn)(void*), void * arg, int intr_alloc_flags, gpio_isr_handle_t *handle)
{
    if (!(fn)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 434, "GPIO ISR null"); }; return (0x102); };
...
esp_err_t gpio_wakeup_enable(gpio_num_t gpio_num, gpio_int_type_t intr_type)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 441, "GPIO number error"); }; return (0x102); };
    esp_err_t ret = 0;
    if (( intr_type == GPIO_INTR_LOW_LEVEL ) || ( intr_type == GPIO_INTR_HIGH_LEVEL )) {
        GPIO.pin[gpio_num].int_type = intr_type;
        GPIO.pin[gpio_num].wakeup_enable = 0x1;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "GPIO wakeup only support Level mode,but edge mode set. gpio_num:%u" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, gpio_num); };
        ret = 0x102;
    }
    return ret;
}
...
esp_err_t gpio_wakeup_disable(gpio_num_t gpio_num)
{
    if (!(((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 455, "GPIO number error"); }; return (0x102); };
...
esp_err_t gpio_set_drive_capability(gpio_num_t gpio_num, gpio_drive_cap_t strength)
{
    if (!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 462, "GPIO number error"); }; return (0x102); };
    if (!(strength < GPIO_DRIVE_CAP_MAX)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 463, "GPIO drive capability error"); }; return (0x102); };

    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        rtc_gpio_set_drive_capability(gpio_num, strength);
    } else {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_BITS for DPORT registers use DPORT_SET_PERI_REG_BITS)"); (("(Cannot use SET_PERI_REG_BITS for DPORT registers use DPORT_SET_PERI_REG_BITS)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 468, __func__, "\"(Cannot use SET_PERI_REG_BITS for DPORT registers use DPORT_SET_PERI_REG_BITS)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 468, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((GPIO_PIN_MUX_REG[gpio_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[gpio_num]))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((GPIO_PIN_MUX_REG[gpio_num])))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 468, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })&(~((0x3)<<(10))))|(((strength) & 0x3)<<(10))); })); });
    }
    return 0;
}
...
esp_err_t gpio_get_drive_capability(gpio_num_t gpio_num, gpio_drive_cap_t* strength)
{
    if (!(((((gpio_num < 40 && GPIO_PIN_MUX_REG[gpio_num] != 0))) && (gpio_num < 34)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 475, "GPIO number error"); }; return (0x102); };
    if (!(strength != 
# 476 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c" 3 4
   ((void *)0)
# 476 "/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c"
   )) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, GPIO_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), GPIO_TAG, __FUNCTION__, 476, "GPIO drive capability pointer error"); }; return (0x102); };

    if (rtc_gpio_is_valid_gpio(gpio_num)) {
        return rtc_gpio_get_drive_capability(gpio_num, strength);
    } else {
        *strength = ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use GET_PERI_REG_BITS2 for DPORT registers use DPORT_GET_PERI_REG_BITS2)"); (("(Cannot use GET_PERI_REG_BITS2 for DPORT registers use DPORT_GET_PERI_REG_BITS2)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 481, __func__, "\"(Cannot use GET_PERI_REG_BITS2 for DPORT registers use DPORT_GET_PERI_REG_BITS2)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; ((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./gpio.c", 481, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((GPIO_PIN_MUX_REG[gpio_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[gpio_num])) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(GPIO_PIN_MUX_REG[gpio_num]))); })>>(10))&(0x3)); });
    }
    return 0;
}
