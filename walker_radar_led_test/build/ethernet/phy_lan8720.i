# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/ethernet//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 15 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 1
# 15 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
...
# 22 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 2
...
# 50 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
void phy_lan8720_power_enable(
# 50 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h" 3 4
                             _Bool
# 50 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
                                 );
...
# 63 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_lan8720.h"
extern const eth_config_t phy_lan8720_default_ethernet_config;
# 19 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 2
# 50 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
...
void phy_lan8720_check_phy_init(void)
{
    ...
    esp_eth_smi_wait_set((0x1f), (1UL << (12)), 0);
}

eth_speed_mode_t phy_lan8720_get_speed_mode(void)
{
    if(esp_eth_smi_read((0x1f)) & (1UL << (3))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_SPEED_MODE_100M;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
...
eth_duplex_mode_t phy_lan8720_get_duplex_mode(void)
{
    if(esp_eth_smi_read((0x1f)) & (1UL << (4))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_MODE_FULLDUPLEX;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_MODE_HALFDUPLEX;
    }
}

void phy_lan8720_power_enable(
# 82 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 3 4
                             _Bool 
# 82 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
                                  enable)
{
    if (enable) {
...
void phy_lan8720_init(void)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_lan8720_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    phy_lan8720_dump_registers();

    esp_eth_smi_write((0x0), (1UL << (15)));

    esp_err_t res1, res2;
    do {

        res1 = esp_eth_smi_wait_value((0x2), 0x0007, 0xffff, 1000);
        res2 = esp_eth_smi_wait_value((0x3), 0xc0f0, 0xFFF0, 1000);
    } while(res1 != 0 || res2 != 0);
...
const eth_config_t phy_lan8720_default_ethernet_config = {
    ...
    .flow_ctrl_enable = 
# 122 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c" 3 4
                       1
# 122 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_lan8720.c"
                           ,
...
void phy_lan8720_dump_registers()
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "LAN8720 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BSR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHY1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHY2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); };
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MCSR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SM     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SECR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x26)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CSIR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x27)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ISR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x29)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "IMR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x30)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PSCSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x31)); };
}
