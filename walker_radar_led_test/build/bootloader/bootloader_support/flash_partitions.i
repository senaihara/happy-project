# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bootloader/bootloader_support//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c"
# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/include/esp_flash_partitions.h" 1
# 17 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/include/esp_flash_partitions.h"
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/include/esp_flash_partitions.h" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/include/esp_flash_partitions.h" 2
...
# 15 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c" 2

static const char *TAG = "flash_parts";

esp_err_t esp_partition_table_basic_verify(const esp_partition_info_t *partition_table, 
# 20 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c" 3 4
                                                                                       _Bool 
# 20 "/Users/Sentaro/esp/esp-idf/components/bootloader_support/src/flash_partitions.c"
                                                                                            log_errors, int *num_partitions)
{
  int num_parts;
  ...
  *num_partitions = 0;
  ...
  for(num_parts = 0; num_parts < (0xC00 / sizeof(esp_partition_info_t)); num_parts++) {
    ...
    if (part->magic == 0xFFFF
      ...
      if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "partition table verified, %d entries" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts); };
    ...
    if (part->magic != 0x50AA) {
        if (log_errors) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "partition %d invalid magic number 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, part->magic); };
        }
        return 0x103;
    }
    ...
    if (pos->offset > chip_size || pos->offset + pos->size > chip_size) {
        if (log_errors) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "partition %d invalid - offset 0x%x size 0x%x exceeds flash chip size 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, num_parts, pos->offset, pos->size, chip_size); }
                                                                  ;
        }
        return 0x104;
    }
  ...
  if (log_errors) {
      if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "partition table has no terminating entry, not valid" "\033[0m" "\n", esp_log_timestamp(), TAG); };
  }
  return 0x103;
}
