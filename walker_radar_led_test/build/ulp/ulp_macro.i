# 1 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/ulp//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 20 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/sens_reg.h" 1
# 27 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2

# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/include/sdkconfig.h" 1
# 29 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 2
...
# 100 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
        ...
        reloc_info_t label_info, reloc_info_t branch_info)
{
    ...
    ((insn->b.opcode == 8 && "branch macro was applied to a non-branch instruction") ? (void)0 : __assert_func (
                                                                     "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
# 107 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
    ,
                                                                     108
# 107 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
    ...
    switch (insn->b.sub_opcode) {
        case 1: {
            ...
            if (abs_offset > 127) {
                if (((esp_log_level_t) 3) >= ESP_LOG_WARN) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "target out of range: branch from %x to %x" "\033[0m" "\n", esp_log_timestamp(), TAG, branch_info.addr, label_info.addr); }
                                                          ;
                return (0x1200 + 5);
            }
        ...
        case 0: {
            ((insn->bx.reg == 0 && "relocation applied to a jump with offset in register") ? (void)0 : __assert_func (
                                                                          "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
# 124 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
            ,
                                                                          125
# 124 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
        ...
        default:
            ((
# 130 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 3 4
           0 
# 130 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
           && "unexpected sub-opcode") ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c", 130, __func__, "false && \"unexpected sub-opcode\""));
    }
    return 0;
}
...
esp_err_t ulp_process_macros_and_load(uint32_t load_addr, const ulp_insn_t* program, size_t* psize)
{
    ...
    if (load_addr > ulp_mem_end) {
        if (((esp_log_level_t) 3) >= ESP_LOG_WARN) { esp_log_write(ESP_LOG_WARN, TAG, "\033[0;" "33" "m" "W" " (%d) %s: " "invalid load address %x, max is %x" "\033[0m" "\n", esp_log_timestamp(), TAG, load_addr, ulp_mem_end); }
                                       ;
        return (0x1200 + 2);
    }
    if (real_program_size + load_addr > ulp_mem_end) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "program too big: %d words, max is %d words" "\033[0m" "\n", esp_log_timestamp(), TAG, real_program_size, ulp_mem_end); }
                                               ;
        return (0x1200 + 1);
    }
    ...
    if (reloc_info == 
# 167 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c" 3 4
                     ((void *)0)
# 167 "/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c"
                         ) {
        return 0x101;
    }
            ...
            switch(r_insn.macro.sub_opcode) {
                ...
                case 1:
                    *cur_reloc = (reloc_info_t) { .label = r_insn.macro.label, .addr = cur_insn_addr, .unused = 0, .type = 1 }
                    ...
                    break;
                default:
                    ((0 && "invalid sub_opcode for macro insn") ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c", 191, __func__, "0 && \"invalid sub_opcode for macro insn\""));
            }
            ++read_ptr;
            ((read_ptr != end && "program can not end with macro insn") ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c", 194, __func__, "read_ptr != end && \"program can not end with macro insn\""));
            ++cur_reloc;
        } else {
    ...
    while(cur_reloc < reloc_end) {
        ...
        ((label_info.type == 0) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/ulp/./ulp_macro.c", 232, __func__, "label_info.type == RELOC_TYPE_LABEL"));
        ++cur_reloc;
        while (cur_reloc < reloc_end) {
            if (cur_reloc->type == 0) {
                if(cur_reloc->label == label_info.label) {
                    if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "duplicate label definition: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, label_info.label); }
                                             ;
                    free(reloc_info);
                    return (0x1200 + 3);
                }
            ...
            if (cur_reloc->label != label_info.label) {
                if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "branch to an inexistent label: %d" "\033[0m" "\n", esp_log_timestamp(), TAG, cur_reloc->label); }
                                         ;
                free(reloc_info);
                return (0x1200 + 4);
            }
