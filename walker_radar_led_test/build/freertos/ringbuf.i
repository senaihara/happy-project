# 1 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/freertos//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/freertos/include/freertos/queue.h" 1
# 19 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 2
...
struct ringbuf_t {
    SemaphoreHandle_t free_space_sem;
    SemaphoreHandle_t items_buffered_sem;
    size_t size;
    uint8_t *write_ptr;
    uint8_t *read_ptr;
    uint8_t *free_ptr;
...
# 69 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
typedef struct {
    size_t len;
    itemflag_t flags;
} buf_entry_hdr_t;
...
static BaseType_t copyItemToRingbufNoSplit(ringbuf_t *rb, uint8_t *buffer, size_t buffer_size)
{
    ...
    if (!(((int)rb->write_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 95, __FUNCTION__); abort(); };
    if (!(rb->write_ptr-(rb->data+rb->size) >= sizeof(buf_entry_hdr_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 96, __FUNCTION__); abort(); };

    size_t rem_len=(rb->data + rb->size) - rb->write_ptr;
...
static BaseType_t copyItemToRingbufAllowSplit(ringbuf_t *rb, uint8_t *buffer, size_t buffer_size)
{
    size_t rbuffer_size;
    rbuffer_size=(buffer_size+3)&~3;
    if (!(((int)rb->write_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 160, __FUNCTION__); abort(); };
    if (!(rb->write_ptr-(rb->data+rb->size) >= sizeof(buf_entry_hdr_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 161, __FUNCTION__); abort(); };
    ...
    if (rem_len < rbuffer_size + sizeof(buf_entry_hdr_t)) {
        ...
        if (!(rem_len>=sizeof(buf_entry_hdr_t))) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 180, __FUNCTION__); abort(); };
...
{
    uint8_t *ret;
    if (!(((int)rb->read_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 264, __FUNCTION__); abort(); };
    if (rb->read_ptr == rb->write_ptr) {

        return 
# 267 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
              ((void *)0)
# 267 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                  ;
    }


    buf_entry_hdr_t *hdr=(buf_entry_hdr_t *)rb->read_ptr;
    if (!((hdr->len < rb->size) || (hdr->flags & iflag_dummydata))) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 272, __FUNCTION__); abort(); };
    if (hdr->flags & iflag_dummydata) {

        rb->read_ptr=rb->data;

        hdr=(buf_entry_hdr_t *)rb->read_ptr;
        if (!(hdr->len < rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 278, __FUNCTION__); abort(); };
...
static uint8_t *getItemFromRingbufByteBuf(ringbuf_t *rb, size_t *length, int wanted_length)
{
    ...
    if (rb->read_ptr != rb->free_ptr) {
        ...
        return 
# 303 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
              ((void *)0)
# 303 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                  ;
    }
    if (rb->read_ptr == rb->write_ptr) {

        return 
# 307 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
              ((void *)0)
# 307 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                  ;
    }
    ret=rb->read_ptr;
    if (rb->read_ptr > rb->write_ptr) {
...
static void returnItemToRingbufDefault(ringbuf_t *rb, void *item) {
    ...
    if (!(((int)rb->free_ptr&3)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 338, __FUNCTION__); abort(); };
    if (!(data >= rb->data)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 339, __FUNCTION__); abort(); };
    if (!(data <= rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 340, __FUNCTION__); abort(); };

    buf_entry_hdr_t *hdr=(buf_entry_hdr_t*)(data-sizeof(buf_entry_hdr_t));
    if (!(hdr->len < rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 343, __FUNCTION__); abort(); };
    if (!((hdr->flags & iflag_dummydata)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 344, __FUNCTION__); abort(); };
    if (!((hdr->flags & iflag_free)==0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 345, __FUNCTION__); abort(); };
    ...
    while (((hdr->flags & iflag_free) || (hdr->flags & iflag_dummydata)) && rb->free_ptr != rb->write_ptr) {
        if (hdr->flags & iflag_dummydata) {
            ...
            if (!(rb->free_ptr<=rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 360, __FUNCTION__); abort(); };
        }
...
static void returnItemToRingbufBytebuf(ringbuf_t *rb, void *item) {
    uint8_t *data=(uint8_t*)item;
    if (!(data >= rb->data)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 380, __FUNCTION__); abort(); };
    if (!(data < rb->data+rb->size)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 381, __FUNCTION__); abort(); };
...
void xRingbufferPrintInfo(RingbufHandle_t ringbuf)
{
    ...
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 389, __FUNCTION__); abort(); };
...
RingbufHandle_t xRingbufferCreate(size_t buf_length, ringbuf_type_t type)
{
    ...
    if (rb==
# 399 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
           ((void *)0)
# 399 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
               ) goto err;
    memset(rb, 0, sizeof(ringbuf_t));
    rb->data = malloc(buf_length);
    if (rb->data == 
# 402 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                   ((void *)0)
# 402 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                       ) goto err;
    rb->size = buf_length;
    rb->free_ptr = rb->data;
    rb->read_ptr = rb->data;
    rb->write_ptr = rb->data;
    rb->free_space_sem = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    rb->items_buffered_sem = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );
    rb->flags=0;
    if (type==RINGBUF_TYPE_ALLOWSPLIT) {
        ...
        if (!(0)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 434, __FUNCTION__); abort(); };
    }
    if (rb->free_space_sem == 
# 436 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                             ((void *)0) 
# 436 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                                  || rb->items_buffered_sem == 
# 436 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                                                               ((void *)0)
# 436 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                                                                   ) goto err;
...
err:
    ...
    if (rb) {
        free(rb->data);
        if (rb->free_space_sem) vQueueDelete( ( QueueHandle_t ) ( rb->free_space_sem ) );
        if (rb->items_buffered_sem) vQueueDelete( ( QueueHandle_t ) ( rb->items_buffered_sem ) );
    }
    free(rb);
    return 
# 449 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
          ((void *)0)
# 449 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
              ;
}
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 465, __FUNCTION__); abort(); };
...
BaseType_t xRingbufferSend(RingbufHandle_t ringbuf, void *data, size_t dataSize, TickType_t ticks_to_wait)
{
    ...
    BaseType_t done=( ( BaseType_t ) 0 );
    TickType_t ticks_end = xTaskGetTickCount() + ticks_to_wait;
    TickType_t ticks_remaining = ticks_to_wait;

    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 477, __FUNCTION__); abort(); };
    ...
    while (!done) {
        ...
        do {
            if (ringbufferFreeMem(rb) < needed_size) {
                ...
                BaseType_t r = xQueueGenericReceive( ( QueueHandle_t ) ( rb->free_space_sem ), 
# 490 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                              ((void *)0)
# 490 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                              , ( ticks_remaining ), ( ( BaseType_t ) 0 ) );
                if (r == ( ( BaseType_t ) 0 )) {
                ...
                if (ticks_to_wait != ( TickType_t ) 0xffffffffUL) {
        ...
        vTaskEnterCritical(&rb->mux);


        done=rb->copyItemToRingbufImpl(rb, data, dataSize);
        vTaskExitCritical(&rb->mux);
    }
    xQueueGenericSend( ( QueueHandle_t ) ( rb->items_buffered_sem ), 
# 517 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
   ((void *)0)
# 517 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
...
BaseType_t xRingbufferSendFromISR(RingbufHandle_t ringbuf, void *data, size_t dataSize, BaseType_t *higher_prio_task_awoken)
{
    ...
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 526, __FUNCTION__); abort(); };
    size_t needed_size=dataSize+sizeof(buf_entry_hdr_t);
    vTaskEnterCritical(&rb->mux);
    if (needed_size>ringbufferFreeMem(rb)) {

        write_succeeded=( ( BaseType_t ) 0 );
    } else {
        write_succeeded = rb->copyItemToRingbufImpl(rb, data, dataSize);
    }
    vTaskExitCritical(&rb->mux);
    if (write_succeeded) {
        xQueueGiveFromISR( ( QueueHandle_t ) ( rb->items_buffered_sem ), ( higher_prio_task_awoken ) );
    }
...
static void *xRingbufferReceiveGeneric(RingbufHandle_t ringbuf, size_t *item_size, TickType_t ticks_to_wait, size_t wanted_size)
{
    ...
    uint8_t *itemData;
    BaseType_t done=( ( BaseType_t ) 0 );
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 548, __FUNCTION__); abort(); };
    while(!done) {

        while (rb->read_ptr == rb->write_ptr) {
            BaseType_t r=xQueueGenericReceive( ( QueueHandle_t ) ( rb->items_buffered_sem ), 
# 552 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                        ((void *)0)
# 552 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                        , ( ticks_to_wait ), ( ( BaseType_t ) 0 ) );
            if (r == ( ( BaseType_t ) 0 )) {

                return 
# 555 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                      ((void *)0)
# 555 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                          ;
            }
        }
...
void *xRingbufferReceiveFromISR(RingbufHandle_t ringbuf, size_t *item_size)
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    uint8_t *itemData;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 580, __FUNCTION__); abort(); };
    vTaskEnterCritical(&rb->mux);
...
void *xRingbufferReceiveUpTo(RingbufHandle_t ringbuf, size_t *item_size, TickType_t ticks_to_wait, size_t wanted_size) {
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (wanted_size == 0) return 
# 589 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                                ((void *)0)
# 589 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                                    ;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 590, __FUNCTION__); abort(); };
    if (!(rb->flags & flag_bytebuf)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 591, __FUNCTION__); abort(); };
...
void *xRingbufferReceiveUpToFromISR(RingbufHandle_t ringbuf, size_t *item_size, size_t wanted_size)
{
    ...
    uint8_t *itemData;
    if (wanted_size == 0) return 
# 599 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
                                ((void *)0)
# 599 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
                                    ;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 600, __FUNCTION__); abort(); };
    if (!(rb->flags & flag_bytebuf)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 601, __FUNCTION__); abort(); };
    vTaskEnterCritical(&rb->mux);
    itemData=rb->getItemFromRingbufImpl(rb, item_size, wanted_size);
    vTaskExitCritical(&rb->mux);
    return (void*)itemData;
...
void vRingbufferReturnItem(RingbufHandle_t ringbuf, void *item)
{
    ...
    vTaskExitCritical(&rb->mux);
    xQueueGenericSend( ( QueueHandle_t ) ( rb->free_space_sem ), 
# 615 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c" 3 4
   ((void *)0)
# 615 "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
}
...
void vRingbufferReturnItemFromISR(RingbufHandle_t ringbuf, void *item, BaseType_t *higher_prio_task_awoken)
{
    ...
    rb->returnItemToRingbufImpl(rb, item);
    vTaskExitCritical(&rb->mux);
    xQueueGiveFromISR( ( QueueHandle_t ) ( rb->free_space_sem ), ( higher_prio_task_awoken ) );
}
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 632, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 640, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 648, __FUNCTION__); abort(); };
...
{
    ringbuf_t *rb=(ringbuf_t *)ringbuf;
    if (!(rb)) { ets_printf("%s:%d (%s)- assert failed!\n", "/Users/Sentaro/esp/esp-idf/components/freertos/./ringbuf.c", 655, __FUNCTION__); abort(); };
