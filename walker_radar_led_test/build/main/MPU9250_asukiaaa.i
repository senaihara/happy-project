# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/main/./MPU9250_asukiaaa.c"
...
# 4 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/main/./MPU9250_asukiaaa.h" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 1
# 22 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h"
...
# 23 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
...
# 25 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
...
# 29 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/i2c.h" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/freertos/include/freertos/queue.h" 1
...
# 2 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/main/./MPU9250_asukiaaa.c" 2

void delay(unsigned long milli_seconds) {
  vTaskDelay(milli_seconds / ( ( TickType_t ) 1000 / ( 1000 ) ));
}
...
static esp_err_t i2c_master_write_slave(uint8_t address, uint8_t* data_wr, size_t size) {
  ...
  i2c_master_stop(cmd);
  esp_err_t ret = i2c_master_cmd_begin(I2C_NUM_0, cmd, 1000 / ( ( TickType_t ) 1000 / ( 1000 ) ));
...
static esp_err_t i2c_master_read_slave(uint8_t address, uint8_t register_address, uint8_t* data_rd, size_t size) {
  ...
  i2c_master_stop(cmd);
  ret = i2c_master_cmd_begin(I2C_NUM_0, cmd, 1000 / ( ( TickType_t ) 1000 / ( 1000 ) ));
  i2c_cmd_link_delete(cmd);
  return ret;
}
...
void mpu9250_mag_set_mode(uint8_t mode) {
  static uint8_t buf[] = {0x0A, 0x00};
  buf[1] = mode;
  printf("set mode\n");
  i2c_master_write_slave(0x0C, buf, 2);
  delay(10);
}

void mpu9250_mag_read_adjust_values(mpu9250_t *data) {
  mpu9250_mag_set_mode(0x0);
  mpu9250_mag_set_mode(0xF);

  uint8_t buff[3];
  i2c_master_read_slave(0x0C, 0x10, buff, 3);
...
void mpu9250_mag_begin(mpu9250_t *data) {
  ...
  mpu9250_mag_set_mode(0x0);
  mpu9250_mag_set_mode(0x2);

}

void mpu9250_mag_update(mpu9250_t *data) {
  i2c_master_read_slave(0x0C, 0x03, data->magBuf, 7);
}
