# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 30 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 32 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 2

static const UINT8 base_uuid[16] = {0xFB, 0x34, 0x9B, 0x5F, 0x80, 0x00, 0x00, 0x80,
                                               0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
                                              };
# 47 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
static void bta_gatt_convert_uuid16_to_uuid128(UINT8 uuid_128[16], UINT16 uuid_16)
{
...
# 64 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 70 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
                                     1
# 70 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
                                         ;
...
# 87 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_RCB *bta_gatts_find_app_rcb_by_app_if(tBTA_GATTS_IF server_if)
{
    UINT8 i;
    tBTA_GATTS_RCB *p_reg;

    for (i = 0, p_reg = bta_gatts_cb.rcb; i < 8; i ++, p_reg++) {
        if (p_reg->in_use && p_reg->gatt_if == server_if) {
            return p_reg;
        }
    }
    return 
# 97 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 97 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 110 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
...
# 130 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_SRVC_CB *bta_gatts_find_srvc_cb_by_srvc_id(tBTA_GATTS_CB *p_cb, UINT16 service_id)
{
    UINT8 i;
    {if (appl_trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_gatts_find_srvc_cb_by_srvc_id  service_id=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", service_id); };};
    for (i = 0; i < 8; i ++) {
        if (p_cb->srvc_cb[i].in_use &&
                p_cb->srvc_cb[i].service_id == service_id) {
            {if (appl_trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "bta_gatts_find_srvc_cb_by_srvc_id  found service cb index =%d" "\033[0m" "\n", esp_log_timestamp(), "BT", i); };};
            return &p_cb->srvc_cb[i];
        }
    }
    return 
# 141 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 141 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 152 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
tBTA_GATTS_SRVC_CB *bta_gatts_find_srvc_cb_by_attr_id(tBTA_GATTS_CB *p_cb, UINT16 attr_id)
{
    ...
    return 
# 175 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
          ((void *)0)
# 175 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
              ;
}
# 186 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
BOOLEAN bta_gatts_uuid_compare(tBT_UUID tar, tBT_UUID src)
{
    ...
    if (src.len == 0 || tar.len == 0) {
        return 
# 193 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c" 3 4
              1
# 193 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/gatt/bta_gatts_utils.c"
                  ;
    }
