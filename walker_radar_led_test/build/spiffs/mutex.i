# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/spiffs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
# 33 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
...
# 34 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 2

# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.h" 1
# 37 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.h"
...
# 36 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 2
...
void mtx_init(struct mtx *mutex, const char *name, const char *type, int opts) {
    mutex->sem = xQueueGenericCreate( ( UBaseType_t ) 1, ( ( uint8_t ) 0U ), ( ( uint8_t ) 3U ) );

    if (mutex->sem) {
        if (port_interruptNesting[xPortGetCoreID()] != 0) {
            BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
            xQueueGiveFromISR( ( QueueHandle_t ) ( mutex->sem ), ( &xHigherPriorityTaskWoken ) );
            if (xHigherPriorityTaskWoken) { _frxt_setup_switch(); };
        } else {
            xQueueGenericSend( ( QueueHandle_t ) ( mutex->sem ), 
# 57 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
           ((void *)0)
# 57 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
           , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        }
    }
}

void __attribute__((section(".iram1"))) mtx_lock(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
        xQueueReceiveFromISR( ( QueueHandle_t ) ( mutex->sem ), 
# 65 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
       ((void *)0)
# 65 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
       , ( &xHigherPriorityTaskWoken ) );
        if (xHigherPriorityTaskWoken) { _frxt_setup_switch(); };
    } else {
        xQueueGenericReceive( ( QueueHandle_t ) ( mutex->sem ), 
# 68 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
       ((void *)0)
# 68 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
       , ( ( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    }
}

int mtx_trylock(struct mtx *mutex) {
    if (xQueueGenericReceive( ( QueueHandle_t ) ( mutex->sem ), 
# 73 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
       ((void *)0)
# 73 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
       , ( 0 ), ( ( BaseType_t ) 0 ) ) == ( ( BaseType_t ) 1 )) {
        return 1;
    } else {
        return 0;
    }
...
void __attribute__((section(".iram1"))) mtx_unlock(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
        xQueueGiveFromISR( ( QueueHandle_t ) ( mutex->sem ), ( &xHigherPriorityTaskWoken ) );
        if (xHigherPriorityTaskWoken) { _frxt_setup_switch(); };
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( mutex->sem ), 
# 86 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
       ((void *)0)
# 86 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
}
...
void mtx_destroy(struct mtx *mutex) {
    if (port_interruptNesting[xPortGetCoreID()] != 0) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( mutex->sem ), 
# 96 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c" 3 4
       ((void *)0)
# 96 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/components/spiffs/./mutex.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }

    vQueueDelete( ( QueueHandle_t ) ( mutex->sem ) );
