...
.LC12:
	...
	.align	4
.LC17:
	.string	"\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff5A000 + 0x098) + 4*i)) >= 0x3ff00000) && (((0x3ff5A000 + 0x098) + 4*i)) <= 0x3ff03FFC))"
	.align	4
.LC20:
