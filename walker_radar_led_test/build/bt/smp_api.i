# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 28 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/include/l2cdefs.h" 1
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 34 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 35 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
BOOLEAN btsnd_hcic_write_authenticated_payload_tout(UINT16 handle,
        UINT16 timeout);
# 36 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
...
# 39 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 2
# 49 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_Init(void)
{
...
# 86 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
extern UINT8 SMP_SetTraceLevel (UINT8 new_level)
{
    if (new_level != 0xFF) {
...
# 105 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_Register (tSMP_CALLBACK *p_cback)
{
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_Register state=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", smp_cb.state); };};

    if (smp_cb.p_callback != 
# 109 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                            ((void *)0)
# 109 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                ) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_Register: duplicate registration, overwrite it" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    }
    smp_cb.p_callback = p_cback;

    return (
# 114 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
           1
# 114 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
               );

}
# 130 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
tSMP_STATUS SMP_Pair (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 status = (0x0E + 0x01);

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s state=%d br_state=%d flag=0x%x \n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_cb->state, p_cb->br_state, p_cb->flags); };}
                                                                            ;
    if (p_cb->state != SMP_STATE_IDLE || p_cb->flags & (1) ||
        ...
        if (!L2CA_ConnectFixedChnl (6, bd_addr)) {
            {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: L2C connect fixed channel failed.\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
...
# 168 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
tSMP_STATUS SMP_BR_PairWith (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 status = (0x0E + 0x01);

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s state=%d br_state=%d flag=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, p_cb->state, p_cb->br_state, p_cb->flags); };}
                                                                        ;
    ...
    p_cb->flags = (1);
    p_cb->smp_over_br = 
# 185 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                       1
# 185 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                           ;

    memcpy (p_cb->pairing_bda, bd_addr, 6);

    if (!L2CA_ConnectFixedChnl (7, bd_addr)) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: L2C connect fixed channel failed." "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
...
# 209 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_PairCancel (BD_ADDR bd_addr)
{
    tSMP_CB *p_cb = &smp_cb;
    UINT8 err_code = 0x08;
    BOOLEAN status = 
# 213 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                      0
# 213 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                           ;

    {if (btm_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_CancelPair state=%d flag=0x%x " "\033[0m" "\n", esp_log_timestamp(), "BT", p_cb->state, p_cb->flags); };};
    if ( (p_cb->state != SMP_STATE_IDLE) &&
            (!memcmp (p_cb->pairing_bda, bd_addr, 6)) ) {
        p_cb->is_pair_cancel = 
# 218 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                              1
# 218 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                  ;
        {if (smp_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Cancel Pairing: set fail reason Unknown" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        smp_sm_event(p_cb, ((0x0F + 1) + 7), &err_code);
        status = 
# 221 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                1
# 221 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                    ;
    }

    return status;
}
# 239 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_SecurityGrant(BD_ADDR bd_addr, UINT8 res)
{
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_SecurityGrant " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
...
# 281 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_PasskeyReply (BD_ADDR bd_addr, UINT8 res, UINT32 passkey)
{
    tSMP_CB *p_cb = & smp_cb;
    UINT8 failure = 0x01;

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply: Key: %d  Result:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", passkey, res); };}
                                  ;


    if (p_cb->cb_evt != 4) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - Wrong State: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", p_cb->state); };};
        return;
    }

    if (memcmp (bd_addr, p_cb->pairing_bda, 6) != 0) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - Wrong BD Addr" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        return;
    }

    if (btm_find_dev (bd_addr) == 
# 300 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 300 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        return;
    }

    if (passkey > (999999) || res != 0) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "SMP_PasskeyReply() - Wrong key len: %d or passkey entry fail" "\033[0m" "\n", esp_log_timestamp(), "BT", passkey); };};
...
# 331 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_ConfirmReply (BD_ADDR bd_addr, UINT8 res)
{
    tSMP_CB *p_cb = & smp_cb;
    UINT8 failure = 0x0C;

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Result:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, res); };};


    if (p_cb->cb_evt != 6) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - Wrong State: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_cb->state); };};
        return;
    }

    if (memcmp (bd_addr, p_cb->pairing_bda, 6) != 0) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - Wrong BD Addr" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
        return;
    }

    if (btm_find_dev (bd_addr) == 
# 349 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 349 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
        return;
    }

    if (res != 0) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - Numeric Comparison fails" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};

        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);
    } else {
        smp_sm_event(p_cb, ((0x0F + 1) + 19), 
# 359 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                            ((void *)0)
# 359 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                                );
    }
}
# 375 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_OobDataReply(BD_ADDR bd_addr, tSMP_STATUS res, UINT8 len, UINT8 *p_data)
{
    ...
    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s State: %d  res:%d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, smp_cb.state, res); };};
...
# 414 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_SecureConnectionOobDataReply(UINT8 *p_data)
{
    ...
    if (!p_oob) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s received no data" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
        smp_sm_event(p_cb, ((0x0F + 1) + 7), &failure);
        return;
    }

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s req_oob_type: %d, loc_oob_data.present: %d, " "peer_oob_data.present: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_cb->req_oob_type, p_oob->loc_oob_data.present, p_oob->peer_oob_data.present); };}
...
# 435 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                           0
# 435 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                ;
    switch (p_cb->req_oob_type) {
    case SMP_OOB_PEER:
        if (!p_oob->peer_oob_data.present) {
            data_missing = 
# 439 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 439 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    case SMP_OOB_LOCAL:
        if (!p_oob->loc_oob_data.present) {
            data_missing = 
# 444 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 444 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    case SMP_OOB_BOTH:
        if (!p_oob->loc_oob_data.present || !p_oob->peer_oob_data.present) {
            data_missing = 
# 449 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          1
# 449 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                              ;
        }
        break;
    default:
        {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unexpected OOB data type requested. Fail OOB" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        data_missing = 
# 454 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                      1
# 454 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                          ;
        break;
    }
...
# 484 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
...
{
    BOOLEAN status = 
# 489 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                    0
# 489 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                         ;
    status = smp_encrypt_data(key, key_len, plain_text, pt_len, p_out);
    return status;
}
# 504 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
void SMP_KeypressNotification (BD_ADDR bd_addr, UINT8 value)
{
    tSMP_CB *p_cb = &smp_cb;

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Value: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, value); };};
    ...
    if (btm_find_dev (bd_addr) == 
# 515 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                 ((void *)0)
# 515 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                     ) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - no dev CB" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
        return;
    }
    ...
    if (p_cb->local_io_capability != 2) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - wrong local IO capabilities %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_cb->local_io_capability); };}
                                                                 ;
        return;
    }

    if (p_cb->selected_association_model != 6) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() - wrong protocol %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_cb->selected_association_model); };}
                                                          ;
        return;
    }
...
# 548 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
BOOLEAN SMP_CreateLocalSecureConnectionsOobData (tBLE_BD_ADDR *addr_to_send_to)
{
    ...
    if (addr_to_send_to == 
# 553 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                          ((void *)0)
# 553 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                              ) {
        {if (smp_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s addr_to_send_to is not provided" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };};
        return 
# 555 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
              0
# 555 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                   ;
    }

    bd_addr = addr_to_send_to->bda;

    {if (smp_cb.trace_level >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s addr type: %u,  BDA: %08x%04x,  state: %u, br_state: %u" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, addr_to_send_to->type, (bd_addr[0] << 24) + (bd_addr[1] << 16) + (bd_addr[2] << 8) + bd_addr[3], (bd_addr[4] << 8) + bd_addr[5], p_cb->state, p_cb->br_state); };}
    ...
    if ((p_cb->state != SMP_STATE_IDLE) || (p_cb->smp_over_br)) {
        {if (smp_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s creation of local OOB data set " "starts only in IDLE state" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__); };}
                                                                     ;
        return 
# 570 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
              0
# 570 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                   ;
    }

    p_cb->sc_oob_data.loc_oob_data.addr_sent_to = *addr_to_send_to;
    smp_sm_event(p_cb, ((0x0F + 1) + 24), 
# 574 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
                                                  ((void *)0)
# 574 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
                                                      );

    return 
# 576 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c" 3 4
          1
# 576 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/smp/smp_api.c"
              ;
}
