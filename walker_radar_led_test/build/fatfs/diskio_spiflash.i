# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio.h" 1
# 12 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio.h"
...
# 13 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio.h" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/sdmmc/include/sdmmc_cmd.h" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/sdmmc_host.h" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.h" 1
# 29 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.h"
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ffconf.h" 1
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/include/sdkconfig.h" 1
# 2 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ffconf.h" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.h" 1
# 23 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.h"
...
# 24 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.h" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c" 2
...
{
    if (((esp_log_level_t) 3) >= ESP_LOG_VERBOSE) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_read - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); };
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    ((wl_handle + 1) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 44, __func__, "wl_handle + 1"));
    esp_err_t err = wl_read(wl_handle, sector * wl_sector_size(wl_handle), buff, count * wl_sector_size(wl_handle));
    if (err != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_read failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    if (((esp_log_level_t) 3) >= ESP_LOG_VERBOSE) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_write - pdrv=%i, sector=%i, count=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, (unsigned int)pdrv, (unsigned int)sector, (unsigned int)count); };
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    ((wl_handle + 1) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 57, __func__, "wl_handle + 1"));
    esp_err_t err = wl_erase_range(wl_handle, sector * wl_sector_size(wl_handle), count * wl_sector_size(wl_handle));
    if (err != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_erase_range failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
        return RES_ERROR;
    }
    err = wl_write(wl_handle, sector * wl_sector_size(wl_handle), buff, count * wl_sector_size(wl_handle));
    if (err != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "wl_write failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    wl_handle_t wl_handle = ff_wl_handles[pdrv];
    if (((esp_log_level_t) 3) >= ESP_LOG_VERBOSE) { esp_log_write(ESP_LOG_VERBOSE, TAG, "V" " (%d) %s: " "ff_wl_ioctl: cmd=%i\n" "\033[0m" "\n", esp_log_timestamp(), TAG, cmd); };
    ((wl_handle + 1) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_spiflash.c", 75, __func__, "wl_handle + 1"));
    switch (cmd) {
    case 0:
        return RES_OK;
    case 1:
