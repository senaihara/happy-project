# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 2
...
# 30 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 2
...
# 32 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 2
# 48 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
...
# 78 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_act_discovery(tGATT_CLCB *p_clcb)
{
    ...
    if (p_clcb->s_handle <= p_clcb->e_handle && p_clcb->s_handle != 0) {
        ...
        if (p_clcb->op_subtype == GATT_DISC_SRVC_BY_UUID) {
            ...
            if (p_clcb->uuid.len == 4) {
                cl_req.find_type_value.value_len = 16;
...
# 113 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                  ((void *)0)
# 113 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                      );
        }
    } else {
        gatt_end_operation(p_clcb, 0x00, 
# 116 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                ((void *)0)
# 116 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                    );
    }
}
# 129 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_act_read (tGATT_CLCB *p_clcb, UINT16 offset)
{
    ...
    case GATT_READ_BY_TYPE:
        ...
        if (p_clcb->op_subtype == GATT_READ_BY_TYPE) {
            ...
            msg.browse.uuid.len = 2;
            msg.browse.uuid.uu.uuid16 = 0x2803;
        }
        break;

    case (GATT_READ_CHAR_VALUE | 0x80):
...
# 159 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                    1
# 159 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                        ;
            } else {
                p_clcb->first_read_blob_after_read = 
# 161 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                    0
# 161 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                         ;
            }

            {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_act_read first_read_blob_after_read=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", p_clcb->first_read_blob_after_read); };}
                                                                ;
            op_code = 0x0C;
    ...
    default:
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown read type: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", p_clcb->op_subtype); };};
        break;
    }
    ...
    if ( op_code == 0 || (rt != 0x00 && rt != 0x86)) {
        gatt_end_operation(p_clcb, rt, 
# 200 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 200 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
    }
}
# 213 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_act_write (tGATT_CLCB *p_clcb, UINT8 sec_act)
{
    tGATT_TCB *p_tcb = p_clcb->p_tcb;
    UINT8 rt = 0x00, op_code = 0;
    ...
    if (p_attr) {
        ...
        case GATT_WRITE:
            if (p_attr->len <= (p_tcb->payload_size - 3)) {
                p_clcb->s_handle = p_attr->handle;
        ...
        default:
            rt = 0x81;
            {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown write type: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", p_clcb->op_subtype); };};
            break;
        }
    } else {
        rt = 0x81;
    ...
    if ((rt != 0x00 && rt != 0x86 && rt != 0x8f)
            || (rt != 0x86 && p_clcb->op_subtype == GATT_WRITE_NO_RSP)) {
        if (rt != 0x00) {
            {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_act_write() failed op_code=0x%x rt=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", op_code, rt); };};
        }
        gatt_end_operation(p_clcb, rt, 
# 267 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 267 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
    }
}
# 279 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_send_queue_write_cancel (tGATT_TCB *p_tcb, tGATT_CLCB *p_clcb, tGATT_EXEC_FLAG flag)
{
    UINT8 rt ;

    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_send_queue_write_cancel " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    rt = attp_send_cl_msg(p_tcb, p_clcb->clcb_idx, 0x18, (tGATT_CL_MSG *)&flag);

    if (rt != 0x00) {
        gatt_end_operation(p_clcb, rt, 
# 288 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 288 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
    }
}
# 300 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
BOOLEAN gatt_check_write_long_terminate(tGATT_TCB *p_tcb, tGATT_CLCB *p_clcb, tGATT_VALUE *p_rsp_value)
{
    tGATT_VALUE *p_attr = (tGATT_VALUE *)p_clcb->p_attr_buf;
    BOOLEAN exec = 
# 303 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                              0
# 303 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                   ;
    tGATT_EXEC_FLAG flag = 0x01;

    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_check_write_long_terminate " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    if (p_rsp_value != 
# 308 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                      ((void *)0)
# 308 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                          ) {
        if (p_rsp_value->handle != p_attr->handle ||
            ...
            flag = 0x00;
            exec = 
# 315 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                  1
# 315 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                      ;
        } else {
            p_clcb->status = 0x00;
            ...
            if ((p_attr->offset += p_rsp_value->len) >= p_attr->len) {
                exec = 
# 320 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                      1
# 320 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                          ;
            }
        }
    }
    if (exec) {
        ...
        return 
# 326 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
              1
# 326 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                  ;
    }
    return 
# 328 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
          0
# 328 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
               ;
}
# 339 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_send_prepare_write(tGATT_TCB *p_tcb, tGATT_CLCB *p_clcb)
{
    tGATT_VALUE *p_attr = (tGATT_VALUE *)p_clcb->p_attr_buf;
    ...
    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_send_prepare_write type=0x%x" "\033[0m" "\n", esp_log_timestamp(), "BT", type); };};
    to_send = p_attr->len - p_attr->offset;

    if (to_send > (p_tcb->payload_size - 5)) {
        to_send = p_tcb->payload_size - 5;
    }
    ...
    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "offset =0x%x len=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", offset, to_send); };};
    ...
    if (rt != 0x00 && rt != 0x86) {
        gatt_end_operation(p_clcb, rt, 
# 374 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 374 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
    }
}
# 389 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_process_find_type_value_rsp (tGATT_TCB *p_tcb, tGATT_CLCB *p_clcb, UINT16 len, UINT8 *p_data)
{
    ...
    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_find_type_value_rsp " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    if (p_clcb->operation != 1 || p_clcb->op_subtype != GATT_DISC_SRVC_BY_UUID) {
        return;
    }

    memset (&result, 0, sizeof(tGATT_DISC_RES));
    result.type.len = 2;
    result.type.uu.uuid16 = 0x2800;


    while (len >= 4) {
        {result.handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
        {result.value.group_value.e_handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
...
# 435 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                ...
                                UINT16 len, UINT8 *p_data)
{
    ...
    if (len < 1) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid Info Response PDU received, discard." "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        gatt_end_operation(p_clcb, 0x04, 
# 446 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                    ((void *)0)
# 446 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                        );
        return;
    }

    if (p_clcb->operation != 1 || p_clcb->op_subtype != GATT_DISC_CHAR_DSCPT) {
        return;
    }
...
# 495 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                              ...
                              UINT16 handle, UINT8 reason)
{
    ...
    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_proc_disc_error_rsp reason: %02x cmd_code %04x" "\033[0m" "\n", esp_log_timestamp(), "BT", reason, opcode); };};
    ...
    case 0x04:
        if (reason == 0x0a) {
            status = 0x00;
            {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Discovery completed" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        }
        break;
    default:
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Incorrect discovery opcode %04x" "\033[0m" "\n", esp_log_timestamp(), "BT", opcode); };};
        break;
    }

    gatt_end_operation(p_clcb, status, 
# 520 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 520 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
}
# 533 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                            ...
                            UINT16 len, UINT8 *p_data)
{
    ...
    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_error_rsp " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
    {opcode = (UINT8)(*(p)); (p) += 1;};
    ...
    if (p_clcb->operation == 1) {
        ...
        if ( (p_clcb->operation == 3) &&
            ...
            gatt_send_queue_write_cancel(p_tcb, p_clcb, 0x00);
        } else if ((p_clcb->operation == 2) &&
                   ((p_clcb->op_subtype == (GATT_READ_CHAR_VALUE | 0x80)) ||
                    (p_clcb->op_subtype == GATT_READ_BY_HANDLE)) &&
                   (opcode == 0x0C) &&
                   p_clcb->first_read_blob_after_read &&
                   (reason == 0x0b)) {
            gatt_end_operation(p_clcb, 0x00, (void *)p_clcb->p_attr_buf);
        } else {
            gatt_end_operation(p_clcb, reason, 
# 569 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                              ((void *)0)
# 569 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                  );
        }
    }
}
# 583 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                  ...
                                  UINT16 len, UINT8 *p_data)
{
    ...
    {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "value resp op_code = %s len = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", gatt_dbg_op_name(op_code), len); };};

    if (len < 4) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "illegal prepare write response length, discard" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        gatt_end_operation(p_clcb, 0x04, &value);
        return;
    }

    {value.handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
    {value.offset = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
...
# 628 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                               ...
                               UINT16 len, UINT8 *p_data)
{
    ...
    UINT8 *p = p_data, i,
                     event = (op_code == 0x1B) ? 6 : 7;

    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_notification " "\033[0m" "\n", esp_log_timestamp(), "BT"); };};

    if (len < 2) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "illegal notification PDU length, discard" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        return;
    }
    ...
    if (!((value.handle) != 0)) {
        ...
        if (op_code == 0x1D) {
            attp_send_cl_msg(p_tcb, 0, 0x1E, 
# 652 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                              ((void *)0)
# 652 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                                  );
        }
        return;
    }
    ...
    if (event == 7) {
        if (p_tcb->ind_count) {
            ...
            {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_notification rcv Ind. but ind_count=%d (will reset ind_count)" "\033[0m" "\n", esp_log_timestamp(), "BT", p_tcb->ind_count); };};
        }
        p_tcb->ind_count = 0;
    }
    ...
    for (i = 0, p_reg = gatt_cb.cl_rcb; i < 8; i++, p_reg++) {
        if (p_reg->in_use && p_reg->app_cb.p_cmpl_cb && (event == 7)) {
            p_tcb->ind_count++;
        }
    }
    ...
    if (event == 7) {
        ...
        if (p_tcb->ind_count > 0) {
            ...
            attp_send_cl_msg(p_tcb, 0, 0x1E, 
# 684 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                              ((void *)0)
# 684 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                                  );
        }
    }
...
# 709 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                    ...
                                    UINT16 len, UINT8 *p_data)
{
    ...
    if (((!p_clcb->p_reg) || (!p_clcb->p_reg->app_cb.p_disc_res_cb)) && (p_clcb->operation == 1)) {
        return;
    }

    if (len < 1) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Illegal ReadByType/ReadByGroupType Response length, discard" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        gatt_end_operation(p_clcb, 0x04, 
# 724 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                    ((void *)0)
# 724 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                        );
        return;
    }

    {value_len = (UINT8)(*(p)); (p) += 1;};

    if ((value_len > (p_tcb->payload_size - 2)) || (value_len > (len - 1)) ) {


        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_read_by_type_rsp: Discard response op_code=%d vale_len=%d > (MTU-2=%d or msg_len-1=%d)" "\033[0m" "\n", esp_log_timestamp(), "BT", op_code, value_len, (p_tcb->payload_size - 2), (len - 1)); };}
                                                                                  ;
        gatt_end_operation(p_clcb, 0x85, 
# 735 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                              ((void *)0)
# 735 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                  );
        return;
    }
    ...
    while (len >= (handle_len + value_len)) {
        ...
        if (!((handle) != 0)) {
            gatt_end_operation(p_clcb, 0x01, 
# 750 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                           ((void *)0)
# 750 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                               );
            return;
        }
        ...
        if (p_clcb->operation == 1 &&
            ...
            if (!((handle) != 0)) {
                gatt_end_operation(p_clcb, 0x01, 
# 768 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                               ((void *)0)
# 768 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                                   );
                return;
            } else {
                record_value.group_value.e_handle = handle;
                if (!gatt_parse_uuid_from_cmd(&record_value.group_value.service_type, value_len, &p)) {
                    {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "discover all service response parsing failure" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
                    break;
                }
            }
        }

        else if (p_clcb->operation == 1 && p_clcb->op_subtype == GATT_DISC_INC_SRVC) {
            {record_value.incl_service.s_handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            {record_value.incl_service.e_handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};

            if (!((record_value.incl_service.s_handle) != 0) ||
                    !((record_value.incl_service.e_handle) != 0)) {
                gatt_end_operation(p_clcb, 0x01, 
# 785 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                               ((void *)0)
# 785 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                                   );
                return;
            }

            if (value_len == 6) {
                {record_value.incl_service.service_type.uu.uuid16 = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
                record_value.incl_service.service_type.len = 2;
            } else if (value_len == 4) {
                p_clcb->s_handle = record_value.incl_service.s_handle;
                p_clcb->read_uuid128.wait_for_read_rsp = 
# 794 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                        1
# 794 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                            ;
                ...
                {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_process_read_by_type_rsp INCL_SRVC failed with invalid data value_len=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", value_len); };};
                gatt_end_operation(p_clcb, 0x04, (void *)p);
                return;
            }
        }

        else if (p_clcb->operation == 2 && p_clcb->op_subtype == GATT_READ_BY_TYPE) {
            p_clcb->counter = len - 2;
            p_clcb->s_handle = handle;
            if ( p_clcb->counter == (p_clcb->p_tcb->payload_size - 4)) {
                p_clcb->op_subtype = GATT_READ_BY_HANDLE;
                if (!p_clcb->p_attr_buf) {
                    p_clcb->p_attr_buf = (UINT8 *)malloc((600));
                }
                if (p_clcb->p_attr_buf && p_clcb->counter <= 600) {
                    memcpy(p_clcb->p_attr_buf, p, p_clcb->counter);
                    gatt_act_read(p_clcb, p_clcb->counter);
                } else {
                    gatt_end_operation(p_clcb, 0x81, (void *)p);
                }
            } else {
                gatt_end_operation(p_clcb, 0x00, (void *)p);
            }
            return;
        } else {
            {record_value.dclr_value.char_prop = (UINT8)(*(p)); (p) += 1;};
            {record_value.dclr_value.val_handle = ((UINT16)(*(p)) + (((UINT16)(*((p) + 1))) << 8)); (p) += 2;};
            if (!((record_value.dclr_value.val_handle) != 0)) {
                gatt_end_operation(p_clcb, 0x01, 
# 830 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                               ((void *)0)
# 830 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                                   );
                return;
            }
            if (!gatt_parse_uuid_from_cmd(&record_value.dclr_value.char_uuid, (UINT16)(value_len - 3), &p)) {
                gatt_end_operation(p_clcb, 0x00, 
# 834 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                        ((void *)0)
# 834 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                            );
        ...
        if (p_clcb->operation == 1 && p_clcb->p_reg->app_cb.p_disc_res_cb) {
            (*p_clcb->p_reg->app_cb.p_disc_res_cb)(p_clcb->conn_id, p_clcb->op_subtype, &result);
        }
    }
...
# 885 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                           ...
                           UINT16 len, UINT8 *p_data)
{
    ...
    if (p_clcb->operation == 2) {
        if (p_clcb->op_subtype != GATT_READ_BY_HANDLE) {
            ...
            if (p_clcb->p_attr_buf && offset < 600) {
                if ((len + offset) > 600) {
                    len = 600 - offset;
                }
                ...
                if (len == (p_tcb->payload_size - 1) &&
                        len + offset < 600) {
                    {if (gatt_cb.trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "full pkt issue read blob for remianing bytes old offset=%d len=%d new offset=%d" "\033[0m" "\n", esp_log_timestamp(), "BT", offset, len, p_clcb->counter); };}
                                                                  ;
                    gatt_act_read(p_clcb, p_clcb->counter);
                } else {
                    gatt_end_operation(p_clcb, 0x00, (void *)p_clcb->p_attr_buf);
                ...
                {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "attr offset = %d p_attr_buf = %p " "\033[0m" "\n", esp_log_timestamp(), "BT", offset, p_clcb->p_attr_buf); };};
                gatt_end_operation(p_clcb, 0x80, (void *)p_clcb->p_attr_buf);
            }
        }
    } else {
        if (p_clcb->operation == 1 &&
            ...
            p_clcb->read_uuid128.wait_for_read_rsp = 
# 934 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                    0
# 934 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                         ;
            if (len == 16) {

                memcpy(p_clcb->read_uuid128.result.value.incl_service.service_type.uu.uuid128, p, len);
                p_clcb->read_uuid128.result.value.incl_service.service_type.len = 16;
                if ( p_clcb->p_reg->app_cb.p_disc_res_cb) {
...
# 962 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_process_handle_rsp(tGATT_CLCB *p_clcb)
{
    gatt_end_operation(p_clcb, 0x00, 
# 964 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                            ((void *)0)
# 964 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                );
}
# 976 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_process_mtu_rsp(tGATT_TCB *p_tcb, tGATT_CLCB *p_clcb, UINT16 len, UINT8 *p_data)
{
    ...
    if (len < 2) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid MTU response PDU received, discard." "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
        status = 0x04;
    } else {
        {mtu = ((UINT16)(*(p_data)) + (((UINT16)(*((p_data) + 1))) << 8)); (p_data) += 2;};

        if (mtu < p_tcb->payload_size && mtu >= 23) {
    ...
    gatt_end_operation(p_clcb, status, 
# 993 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                      ((void *)0)
# 993 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                          );
}
# 1005 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
UINT8 gatt_cmd_to_rsp_code (UINT8 cmd_code)
{
    UINT8 rsp_code = 0;

    if (cmd_code > 1 && cmd_code != 0x52) {
        rsp_code = cmd_code + 1;
    }
    return rsp_code;
}
# 1023 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
BOOLEAN gatt_cl_send_next_cmd_inq(tGATT_TCB *p_tcb)
{
    tGATT_CMD_Q *p_cmd = &p_tcb->cl_cmd_q[p_tcb->pending_cl_req];
    BOOLEAN sent = 
# 1026 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                      0
# 1026 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                           ;
    UINT8 rsp_code;
    tGATT_CLCB *p_clcb = 
# 1028 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                          ((void *)0)
# 1028 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                              ;
    tGATT_STATUS att_ret = 0x00;

    while (!sent &&
            p_tcb->pending_cl_req != p_tcb->next_slot_inq &&
            p_cmd->to_send && p_cmd->p_cmd != 
# 1033 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                             ((void *)0)
# 1033 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                 ) {
        att_ret = attp_send_msg_to_l2cap(p_tcb, p_cmd->p_cmd);

        if (att_ret == 0x00 || att_ret == 0x8f) {
            sent = 
# 1037 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                  1
# 1037 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                      ;
            p_cmd->to_send = 
# 1038 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                            0
# 1038 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                 ;
            p_cmd->p_cmd = 
# 1039 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                          ((void *)0)
# 1039 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                              ;


            if (p_cmd->op_code != 0x52 && p_cmd->op_code != 0xD2) {
                ...
                if (att_ret == 0x00) {
                    sent = 
# 1049 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                          0
# 1049 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                               ;
                }

                p_cmd = &p_tcb->cl_cmd_q[p_tcb->pending_cl_req];

                gatt_end_operation(p_clcb, att_ret, 
# 1054 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                   ((void *)0)
# 1054 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                       );
            }
        } else {
            {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "gatt_cl_send_next_cmd_inq: L2CAP sent error" "\033[0m" "\n", esp_log_timestamp(), "BT"); };};
...
# 1079 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
void gatt_client_handle_server_rsp (tGATT_TCB *p_tcb, UINT8 op_code,
                                    UINT16 len, UINT8 *p_data)
{
    tGATT_CLCB *p_clcb = 
# 1082 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                          ((void *)0)
# 1082 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                              ;
    UINT8 rsp_code;

    if (op_code != 0x1D && op_code != 0x1B) {
        p_clcb = gatt_cmd_dequeue(p_tcb, &rsp_code);

        rsp_code = gatt_cmd_to_rsp_code(rsp_code);

        if (p_clcb == 
# 1090 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                     ((void *)0) 
# 1090 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                          || (rsp_code != op_code && op_code != 0x01)) {
            {if (gatt_cb.trace_level >= 2) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "ATT - Ignore wrong response. Receives (%02x)                                 Request(%02x) Ignored" "\033[0m" "\n", esp_log_timestamp(), "BT", op_code, rsp_code); };}
                                                                          ;
    ...
    if (len >= p_tcb->payload_size) {
        {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "invalid response/indicate pkt size: %d, PDU size: %d" "\033[0m" "\n", esp_log_timestamp(), "BT", len + 1, p_tcb->payload_size); };};
        if (op_code != 0x1B &&
                op_code != 0x1D) {
            gatt_end_operation(p_clcb, 0x85, 
# 1106 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                  ((void *)0)
# 1106 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                      );
        }
    } else {
        switch (op_code) {
        ...
        case 0x19:
            gatt_end_operation(p_clcb, p_clcb->status, 
# 1146 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c" 3 4
                                                      ((void *)0)
# 1146 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/stack/gatt/gatt_cl.c"
                                                          );
            break;
        ...
        default:
            {if (gatt_cb.trace_level >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Unknown opcode = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", op_code); };};
            break;
        }
    }
