# 1 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/coap//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 17 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
# 18 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 27 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
# 1 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/posix/sys/socket.h" 1
# 28 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 44 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
int coap_get_data(coap_pdu_t *pdu,
                  size_t *len,
                  unsigned char **data);
# 45 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
# 46 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
# 47 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
...
void coap_packet_get_memmapped(coap_packet_t *packet,
                               ...
                               size_t *length);
# 48 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 2
# 68 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
struct coap_packet_t {
...
# 136 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
coap_new_endpoint(const coap_address_t *addr, int flags) {
  int sockfd = lwip_socket(addr->addr.sa.sa_family,2,0);
  int on = 1;
  ...
  if (sockfd < 0) {
    ...
    return 
# 154 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 154 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }

  if (lwip_setsockopt_r(sockfd,0xfff,0x0004,&on,sizeof(on)) < 0)
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: setsockopt SO_REUSEADDR");

  if (lwip_bind_r(sockfd,&addr->addr.sa,addr->size) < 0) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: bind");
    lwip_close_r(sockfd);
    return 
# 163 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 163 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (!ep) {
    ...
    lwip_close_r(sockfd);
    return 
# 170 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 170 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
  ...
  if (lwip_getsockname_r(sockfd,&ep->addr.addr.sa,&ep->addr.size) < 0) {
    coap_log_impl(LOG_WARNING, "coap_new_endpoint: cannot determine local address");
    lwip_close_r(sockfd);
    return 
# 181 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
          ((void *)0)
# 181 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
              ;
  }
...
# 220 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
struct in6_pktinfo {
...
# 243 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
ssize_t
coap_network_send(struct coap_context_t *context __attribute__ ((unused)),
  ...
  return lwip_sendto_r(ep->handle.fd,data,datalen,0,(struct sockaddr*)&dst->addr.sa,sizeof(struct sockaddr));
...
# 271 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
# 300 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
...
coap_network_read(coap_endpoint_t *ep, coap_packet_t **packet) {
  ...
  char *soc_appdata = 
# 342 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
                     ((void *)0)
# 342 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
                         ;
  struct sockaddr_in soc_srcipaddr;
  socklen_t soc_srcsize = sizeof(struct sockaddr_in);


  ((ep) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c", 347, __func__, "ep"));
  ((packet) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c", 348, __func__, "packet"));
  ...
  *packet = coap_malloc_packet();
  ...
  if (soc_appdata){
   len = lwip_recvfrom_r(ep->handle.fd,soc_appdata,1460,0,(struct sockaddr *)&soc_srcipaddr,(socklen_t *)&soc_srcsize);
   ...
   if (len < 0){
    ...
    goto error;
       ...
       if (lwip_getsockname_r(ep->handle.fd,&(*packet)->dst.addr.sa,&(*packet)->dst.size) < 0) {
   ...
   soc_appdata = 
# 398 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
                ((void *)0)
# 398 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
                    ;
  } else {
   goto error;
  }
# 452 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
  (*packet)->interface = ep;
 ...
 error:
  ...
  if (soc_appdata)
   coap_free(soc_appdata);
  soc_appdata = 
# 459 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
               ((void *)0)
# 459 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
                   ;

  coap_free_packet(*packet);
  *packet = 
# 462 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c" 3 4
           ((void *)0)
# 462 "/Users/Sentaro/esp/esp-idf/components/coap/port/coap_io_socket.c"
               ;
  return -1;
}
