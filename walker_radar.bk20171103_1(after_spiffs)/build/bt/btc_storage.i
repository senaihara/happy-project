# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/include/btc_storage.h" 1
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/include/btc_storage.h"
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/include/btc_storage.h" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/include/btc_storage.h" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/include/bt_trace.h" 1
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 2
# 36 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_add_bonded_device(bt_bdaddr_t *remote_bd_addr,
        LINK_KEY link_key,
        uint8_t key_type,
        uint8_t pin_length)
{
    ...
    do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "add to storage: Remote device:%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT", bdstr); };} while(0);
    ...
    btc_config_flush();
    do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Storage add rslt %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT", ret); };} while(0);
    return ret ? BT_STATUS_SUCCESS : BT_STATUS_FAIL;
}
# 65 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
static bt_status_t btc_in_fetch_bonded_devices(int add)
{
    BOOLEAN bt_linkkey_file_found = 
# 67 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 3 4
                                   0
# 67 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
                                        ;
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end(); iter = btc_config_section_next(iter)) {
        ...
        do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Remote device:%s\n" "\033[0m" "\n", esp_log_timestamp(), "BT", name); };} while(0);
        LINK_KEY link_key;
...
# 98 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c" 3 4
                                       1
# 98 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
                                           ;
            } else {
                do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "bounded device:%s, LinkKeyType or PinLength is invalid\n" "\033[0m" "\n", esp_log_timestamp(), "BT", name); };} while(0);
            }
        }
        if (!bt_linkkey_file_found) {
            do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Remote device:%s, no link key\n" "\033[0m" "\n", esp_log_timestamp(), "BT", name); };} while(0);
        }
    }
    return BT_STATUS_SUCCESS;
}
# 123 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_load_bonded_devices(void)
{
    bt_status_t status;
...
# 141 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_storage.c"
bt_status_t btc_storage_remove_bonded_device(bt_bdaddr_t *remote_bd_addr)
{
    bdstr_t bdstr;
    bdaddr_to_string(remote_bd_addr, bdstr, sizeof(bdstr));
