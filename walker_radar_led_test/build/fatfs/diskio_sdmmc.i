# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c" 2

static sdmmc_card_t* s_cards[2] = { 
# 21 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c" 3 4
                                          ((void *)0) 
# 21 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c"
                                               };
...
DRESULT ff_sdmmc_read (BYTE pdrv, BYTE* buff, DWORD sector, UINT count)
{
    ...
    ((card) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c", 38, __func__, "card"));
    esp_err_t err = sdmmc_read_sectors(card, buff, sector, count);
    if (err != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_read_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    sdmmc_card_t* card = s_cards[pdrv];
    ((card) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c", 50, __func__, "card"));
    esp_err_t err = sdmmc_write_sectors(card, buff, sector, count);
    if (err != 0) {
        if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "sdmmc_write_blocks failed (%d)" "\033[0m" "\n", esp_log_timestamp(), TAG, err); };
        return RES_ERROR;
    }
    return RES_OK;
}
...
{
    sdmmc_card_t* card = s_cards[pdrv];
    ((card) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/fatfs/src/diskio_sdmmc.c", 62, __func__, "card"));
    switch(cmd) {
        case 0:
            return RES_OK;
        case 1:
