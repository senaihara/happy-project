# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 25 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 2
...
{
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff03FFC)), (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff03FFC))) ? (void)0 : __assert_func (




 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
# 51 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
    ,
 ...
 56
# 51 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
    , __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((0x3ff48000 + 0xd4))) >= 0x3ff00000) && (((0x3ff48000 + 0xd4))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((0x3ff48000 + 0xd4))) = (((1UL << (30))) | ((1UL << (15))) | (2 << 16) | (0 << 27)); })
    ...
    do { esp_err_t rc = (rtc_isr_register(rtc_brownout_isr_handler, 
# 58 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c" 3 4
   ((void *)0)
# 58 "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c"
   , ((1UL << (7))))); if (rc != 0) { _esp_error_check_failed(rc, "/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c", 58, __func__, "rtc_isr_register(rtc_brownout_isr_handler, NULL, RTC_CNTL_BROWN_OUT_INT_ENA_M)"); } } while(0);;

    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff03FFC)), (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)"); (("(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)" && (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/esp32/./brownout.c", 60, __func__, "\"(Cannot use REG_SET_BIT for DPORT registers use DPORT_REG_SET_BIT)\" && (!(((((0x3ff48000 + 0x3c))) >= 0x3ff00000) && (((0x3ff48000 + 0x3c))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t*)((0x3ff48000 + 0x3c)) |= (((1UL << (7))))); });
}
