# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
# 33 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 34 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 39 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 41 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 44 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 48 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
...
# 52 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 2
# 61 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 100 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                     ...
                     void *p_rng )
{
    ...
    if( ( ret = dhm_check_range( &ctx->GX, &ctx->P ) ) != 0 )
        return( ret );
# 195 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
    n1 = mbedtls_mpi_size( &ctx->P );
    n2 = mbedtls_mpi_size( &ctx->G );
    n3 = mbedtls_mpi_size( &ctx->GX );

    p = output;
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->P, p + 2, n1 ) ) != 0 ) goto cleanup; } while( 0 ); *p++ = (unsigned char)( n1 >> 8 ); *p++ = (unsigned char)( n1 ); p += n1;;
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->G, p + 2, n2 ) ) != 0 ) goto cleanup; } while( 0 ); *p++ = (unsigned char)( n2 >> 8 ); *p++ = (unsigned char)( n2 ); p += n2;;
    do { if( ( ret = mbedtls_mpi_write_binary( &ctx->GX, p + 2, n3 ) ) != 0 ) goto cleanup; } while( 0 ); *p++ = (unsigned char)( n3 >> 8 ); *p++ = (unsigned char)( n3 ); p += n3;;
                     ...
                     const unsigned char *input, size_t ilen )
{
    ...
    if( ctx == 
# 224 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 224 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || ilen < 1 || ilen > ctx->len )
        return( -0x3080 );
                     ...
                     void *p_rng )
{
    ...
    if( ctx == 
# 243 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 243 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || olen < 1 || olen > ctx->len )
        return( -0x3080 );
                     ...
                     void *p_rng )
{
    ...
    if( ctx == 
# 356 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
              ((void *)0) 
# 356 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                   || output_size < ctx->len )
        return( -0x3080 );
    ...
    if( f_rng != 
# 365 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                ((void *)0) 
# 365 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                     )
    {
    ...
    if( f_rng != 
# 379 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                ((void *)0) 
# 379 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                     )
    {
                   ...
                   size_t dhminlen )
{
    ...
    if( dhminlen == 0 || dhmin[dhminlen - 1] != '\0' )
        ...
        ret = mbedtls_pem_read_buffer( &pem,
                               ...
                               "-----END DH PARAMETERS-----",
                               dhmin, 
# 433 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                     ((void *)0)
# 433 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                                         , 0, &dhminlen );
...
# 458 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
...
# 517 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
static int load_file( const char *path, unsigned char **buf, size_t *n )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 522 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                      ((void *)0) 
# 522 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                                           )
        return( -0x3480 );
    ...
    *n = (size_t) size;
    ...
    if( *n + 1 == 0 ||
        ( *buf = calloc( 1, *n + 1 ) ) == 
# 536 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                                 ((void *)0) 
# 536 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                                                      )
    {
        fclose( f );
        return( -0x3400 );
...
# 553 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c" 3 4
                                                       ((void *)0) 
# 553 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/dhm.c"
                                                            )
        ++*n;
