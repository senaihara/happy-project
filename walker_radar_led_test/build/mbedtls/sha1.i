# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
# 30 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
...
# 31 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c" 2
...
# 34 "/Users/Sentaro/esp/esp-idf/components/mbedtls/include/mbedtls/sha1.h" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c" 2
...
# 38 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c" 2
...
# 42 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c" 2
# 51 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
static void mbedtls_zeroize( void *v, size_t n ) {
    volatile unsigned char *p = (unsigned char*)v; while( n-- ) *p++ = 0;
}
# 78 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
void mbedtls_sha1_init( mbedtls_sha1_context *ctx )
{
...
{
    if( ctx == 
# 85 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c" 3 4
              ((void *)0) 
# 85 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
                   )
        return;
...
# 148 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/sha1.c"
    A = ctx->state[0];
    B = ctx->state[1];
    C = ctx->state[2];
    D = ctx->state[3];
...
void mbedtls_sha1_finish( mbedtls_sha1_context *ctx, unsigned char output[20] )
{
    ...
    { (msglen)[(0) ] = (unsigned char) ( (high) >> 24 ); (msglen)[(0) + 1] = (unsigned char) ( (high) >> 16 ); (msglen)[(0) + 2] = (unsigned char) ( (high) >> 8 ); (msglen)[(0) + 3] = (unsigned char) ( (high) ); };
    { (msglen)[(4) ] = (unsigned char) ( (low) >> 24 ); (msglen)[(4) + 1] = (unsigned char) ( (low) >> 16 ); (msglen)[(4) + 2] = (unsigned char) ( (low) >> 8 ); (msglen)[(4) + 3] = (unsigned char) ( (low) ); };
