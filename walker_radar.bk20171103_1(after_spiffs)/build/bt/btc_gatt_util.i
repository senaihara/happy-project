# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 1
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h"
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/include/btc_gatt_util.h" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 2
...
void btc128_to_bta_uuid(tBT_UUID *p_dest, uint8_t *p_src)
{
    ...
    default:
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s: Unknown UUID length %d!" "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_dest->len); };} while(0);
        break;
    }
}
...
void btc_to_bta_uuid(tBT_UUID *p_dest, esp_bt_uuid_t *p_src)
{
    ...
    if (p_src->len == 2) {
        ...
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s UUID len is invalid %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, p_src->len); };} while(0);
    }
}
...
uint16_t set_read_value(uint8_t *gattc_if, esp_ble_gattc_cb_param_t *p_dest, tBTA_GATTC_READ *p_src)
{
    ...
    *gattc_if = ((uint8_t)(p_src->conn_id));
    ...
    case 0x2905:
        ...
        p_dest->read.value_type = 0x2905;
        p_dest->read.value_len = 0;
        break;

    default:
        if (( p_src->status == 0x00 ) && (p_src->p_value != 
# 199 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 3 4
                                                                  ((void *)0)
# 199 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
                                                                      )) {
            do {if (3 >= 3) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s unformat.len = %d " "\033[0m" "\n", esp_log_timestamp(), "BT", __FUNCTION__, p_src->p_value->unformat.len); };} while(0);
            p_dest->read.value_len = p_src->p_value->unformat.len;
            if ( p_src->p_value->unformat.len > 0 && p_src->p_value->unformat.p_value != 
# 202 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c" 3 4
                                                                                         ((void *)0) 
# 202 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/profile/std/gatt/btc_gatt_util.c"
                                                                                              ) {
