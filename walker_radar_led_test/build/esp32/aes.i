# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/esp32//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c"
# 28 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c"
...
# 29 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
...
# 30 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
...
# 32 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/hwcrypto_reg.h" 1
# 33 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
...
# 38 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 2
# 49 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c"
...
void esp_aes_acquire_hardware( void )
{
    ...
    esp_dport_access_stall_other_cpu_start();
    {
        ...
        (*(volatile uint32_t *)(((0x3ff00000 + 0x01C)))) = (((*(volatile uint32_t *)((0x3ff00000 + 0x01C)))|((1<<0))));


        (*(volatile uint32_t *)(((0x3ff00000 + 0x020)))) = (((*(volatile uint32_t *)((0x3ff00000 + 0x020))) & (~((1<<0) | (1<<4) | (1<<3)))))
...
void esp_aes_release_hardware( void )
{
    esp_dport_access_stall_other_cpu_start();
    {
        ...
        (*(volatile uint32_t *)(((0x3ff00000 + 0x020)))) = (((*(volatile uint32_t *)((0x3ff00000 + 0x020)))|((1<<0))));
...
{
    if ( ctx == 
# 92 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c" 3 4
               ((void *)0) 
# 92 "/Users/Sentaro/esp/esp-idf/components/esp32/hwcrypto/aes.c"
                    ) {
        return;
    }
...
static inline void esp_aes_block(const void *input, void *output)
{
    ...
    esp_dport_access_stall_other_cpu_start();
    {
        while ((*(volatile uint32_t *)(((0x3ff01000) + 0x04))) != 1) { }
        for (int i = 0; i < 4; i++) {
