...
arg_date_resetfn:
.LFB1:
	.file 1 "/Users/Sentaro/esp/esp-idf/components/console/argtable3/argtable3.c"
	.loc 1 849 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.LVL108:
	...
	extui	a2, a2, 0, 3
	bnez.n	a2, .L93
	.loc 1 3261 0 is_stmt 0 discriminator 2
	movi.n	a2, 0x5f
	bne	a9, a2, .L94
	.loc 1 3261 0
	movi.n	a2, 1
...
.L102:
.LBE16:
	.loc 1 3286 0 discriminator 4
	blt	a10, a12, .L103
.LBB17:
	.loc 1 3286 0 discriminator 5
	l32i.n	a12, a3, 8
.LVL138:
	add.n	a13, a11, a12
	l8ui	a13, a13, 1
...
.LVL267:
.LBB30:
	.loc 1 3451 0 discriminator 5
	bnei	a2, 2, .L172
	.loc 1 3451 0 discriminator 6
	addi	a6, a6, -32
.LVL268:
.L172:
.LBE30:
	.loc 1 3451 0 discriminator 9
	beq	a6, a3, .L171
	j	.L195
.LVL269:
.L169:
...
.LVL361:
.L236:
	.loc 1 3958 0 discriminator 4
	add.n	a4, a4, a10
.LVL362:
.LBE36:
	.loc 1 3955 0 is_stmt 1 discriminator 4
	addi.n	a3, a3, 1
.LVL363:
.L235:
...
.L243:
.LBE38:
	.loc 1 3970 0 is_stmt 1 discriminator 2
	addi.n	a3, a3, 1
.LVL377:
.L239:
...
.L414:
	...
	movi.n	a10, 1
.L399:
	.loc 1 3881 0 discriminator 4
	add.n	a7, a7, a10
.LVL657:
	.loc 1 3882 0 is_stmt 1 discriminator 4
	j	.L400
.L401:
	.loc 1 3884 0
	addi.n	a6, a6, 1
...
.L411:
.LBE59:
	.loc 1 3907 0 is_stmt 1 discriminator 2
	addi.n	a5, a5, 1
.LVL681:
.L404:
...
.LVL707:
	...
	l8ui	a8, a8, 0
	bnez.n	a8, .L430
	.loc 1 4054 0 is_stmt 1 discriminator 2
	l8ui	a8, a9, 0
...
.LVL1150:
	...
	s32i.n	a10, a2, 0
	.loc 1 3558 0 is_stmt 1 discriminator 1
	movi.n	a2, 1
	retw.n
.LVL1151:
.L661:
...
.LCFI85:
	.loc 1 3573 0
	bltz	a3, .L670
	.loc 1 3573 0 is_stmt 0 discriminator 2
	l32i.n	a8, a2, 32
	bge	a3, a8, .L671
...
.LVL1174:
.L674:
	.loc 1 3732 0 is_stmt 0 discriminator 4
	s32i.n	a4, a10, 12
	.loc 1 3733 0 is_stmt 1 discriminator 4
	s32i.n	a7, a10, 16
	.loc 1 3734 0 discriminator 4
	s32i.n	a5, a10, 20
...
.L676:
	...
	l32r	a2, .LC181
	s32i.n	a2, a4, 0
	.loc 1 3747 0 discriminator 3
	addi.n	a3, a3, 1
.LVL1179:
.L675:
	.loc 1 3747 0 is_stmt 0 discriminator 1
	blt	a3, a6, .L676
.LVL1180:
.L673:
.LBE82:
...
.L738:
.LVL1312:
	.loc 1 4626 0 is_stmt 0 discriminator 1
	l32i.n	a9, a6, 0
	l32i.n	a8, a9, 20
	blt	a5, a8, .L740
...
.Letext0:
	...
	.file 3 "/Users/Sentaro/esp/xtensa-esp32-elf/lib/gcc/xtensa-esp32-elf/5.2.0/include/stdarg.h"
	.file 4 "<built-in>"
	...
	.file 9 "/Users/Sentaro/esp/esp-idf/components/newlib/include/time.h"
	.file 10 "/Users/Sentaro/esp/esp-idf/components/console/argtable3/argtable3.h"
	.file 11 "/Users/Sentaro/esp/esp-idf/components/newlib/include/machine/setjmp.h"
	.file 12 "/Users/Sentaro/esp/esp-idf/components/newlib/include/ctype.h"
	...
	.file 15 "/Users/Sentaro/esp/esp-idf/components/newlib/include/setjmp.h"
...
.LASF307:
	.string	"newn"
.LASF447:
	.string	"/Users/Sentaro/esp/esp-idf/components/console/argtable3/argtable3.c"
.LASF373:
	.string	"trex_search"
.LASF446:
...
.LASF34:
	.string	"__tm_sec"
.LASF448:
	.string	"/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/console"
.LASF41:
	.string	"__tm_yday"
.LASF423:
	.string	"strtol"
