# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar/build/bt//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
# 15 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/include/bta_gatts_co.h" 1
# 27 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/include/bta_gatts_co.h"
...
# 28 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/bta/include/bta_gatts_co.h" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 2
...
# 43 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_load_bonded_ble_devices(void)
{
    bt_status_t status;
    status = btc_in_fetch_bonded_ble_devices(1);
    do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Storage load rslt %d\n" "\033[0m" "\n", esp_log_timestamp(), "BT", status); };} while(0);
    return status;
}
...
bt_status_t btc_in_fetch_bonded_ble_devices(int add)
{
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end();
        ...
        if (!string_is_bdaddr(name) ||
            !btc_config_get_int(name, "DevType", &device_type) ||
            ((device_type & 0x02) != 0x02)) {
            continue;
        }
        do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, name = %s" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, name); };} while(0);
        if (btc_in_fetch_bonded_ble_device(name, add, &bonded_devices) != BT_STATUS_SUCCESS) {
            do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "Remote device:%s, no link key or ble key found" "\033[0m" "\n", esp_log_timestamp(), "BT", name); };} while(0);
        } else {
...
bt_status_t btc_get_bonded_ble_devices_list(esp_ble_bond_dev_t *bond_dev)
{
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end();
        ...
        if (btc_storage_get_ble_bonding_key(&bd_addr, (1 << 0), buffer, sizeof(tBTM_LE_PENC_KEYS))
            == BT_STATUS_SUCCESS) {
            bond_dev->bond_key.key_mask |= (1 << 0);
            memcpy(&bond_dev->bond_key.penc_key, buffer, sizeof(tBTM_LE_PENC_KEYS));
        }

        if (btc_storage_get_ble_bonding_key(&bd_addr, (1 << 2), buffer, sizeof(tBTM_LE_PCSRK_KEYS))
            == BT_STATUS_SUCCESS) {
            bond_dev->bond_key.key_mask |= (1 << 2);
            memcpy(&bond_dev->bond_key.pcsrk_key, buffer, sizeof(tBTM_LE_PCSRK_KEYS));
        }

        if (btc_storage_get_ble_bonding_key(&bd_addr, (1 << 1), buffer, sizeof(tBTM_LE_PID_KEYS))
            == BT_STATUS_SUCCESS) {
...
void btc_save_ble_bonding_keys(void)
{
    ...
    btc_config_set_int(bdstr, "DevType", 0x02);
    do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, penc = %d, pid = %d" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, pairing_cb.ble.is_penc_key_rcvd, pairing_cb.ble.is_pid_key_rcvd); };} while(0);
...
# 172 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                                       ((void *)0)
# 172 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                           ,
                                        ((1 << 1) << 4),
                                        0);
    }
...
# 179 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                                               _Bool 
# 179 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                                    add_key, 
# 179 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                                                             _Bool 
# 179 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
...
# 179 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                                                                      *key_found)
{
    ((device_added) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c", 181, __func__, "device_added"));
    ((key_found) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c", 182, __func__, "key_found"));
    ...
    if (btc_storage_get_ble_bonding_key(&bd_addr, key_type, buffer, key_len) == BT_STATUS_SUCCESS) {
        if (add_key) {
            ...
            if (!*device_added) {
                ...
                *device_added = 
# 193 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                               1
# 193 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                   ;
            }

            char bd_str[20] = {0};
            do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s() Adding key type %d for %s" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, key_type, bdaddr_to_string(&bd_addr, bd_str, sizeof(bd_str))); };} while(0)
                                                                             ;
            BTA_DmAddBleKey(bta_bd_addr, (tBTA_LE_KEY_VALUE *)buffer, key_type);
        }

        *key_found = 
# 202 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                    1
# 202 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                        ;
    }
}
...
# 253 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_get_ble_bonding_key(bt_bdaddr_t *remote_bd_addr,
                                            uint8_t key_type,
                                            char *key_value,
                                            int key_length)
...
# 288 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
_Bool 
# 288 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
    btc_storage_compare_address_key_value(bt_bdaddr_t *remote_bd_addr,
                                                   uint8_t key_type, void *key_value, int key_length)
{
    bdstr_t bdstr;
    ...
    default:
        return 
# 313 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
              0
# 313 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                   ;
    }

    return btc_compare_address_key_value(bdstr, key_type_str, key_value, key_length);
}
# 330 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_remove_ble_bonding_keys(bt_bdaddr_t *remote_bd_addr)
{
    bdstr_t bdstr;
    bdaddr_to_string(remote_bd_addr, bdstr, sizeof(bdstr));
    {if (btif_trace_level >= 5) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " " %s in bd addr:%s" "\033[0m" "\n", esp_log_timestamp(), "BT",__FUNCTION__, bdstr); };};
    int ret = 1;
    if (btc_config_exist(bdstr, "DevType")) {
...
bt_status_t btc_storage_clear_bond_devices(void)
{
    ...
    for (const btc_config_section_iter_t *iter = btc_config_section_begin(); iter != btc_config_section_end();
        ...
        if (btc_storage_remove_ble_bonding_keys(&bd_addr) != BT_STATUS_SUCCESS) {
            do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, remove bonding key faild" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };} while(0);
            return BT_STATUS_FAIL;
        }
        ...
        for (int i = 0; i < bonded_devices.num_devices; i++) {
            ...
            if (!memcmp(bd_addr.address, bonded_devices.devices[i].address, sizeof(bt_bdaddr_t))) {
                ...
                if(BTA_DmRemoveDevice(bta_addr) != 0) {
                    do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, remove device faild" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };} while(0);
                    return BT_STATUS_FAIL;
                }
            }
        }
...
# 406 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_add_ble_local_key(char *key,
                                          uint8_t key_type,
                                          uint8_t key_length)
{
...
# 442 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_get_ble_local_key(uint8_t key_type,
                                          char *key_value,
                                          int key_length)
{
...
# 478 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_remove_ble_local_keys(void)
{
    int ret = 1;
...
# 505 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
   _Bool 
# 505 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
        device_added = 
# 505 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                       0
# 505 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
...
# 506 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
   _Bool 
# 506 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
        key_found = 
# 506 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                    0
# 506 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
    ...
    if (!btc_config_get_int(remote_bd_addr, "DevType", &device_type)) {
        do {if (3 >= 1) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s, device_type = %x" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__, device_type); };} while(0);
        return BT_STATUS_FAIL;
    }
    ...
    if (btc_storage_get_remote_addr_type(&bd_addr, &addr_type) != BT_STATUS_SUCCESS) {
        addr_type = 0x00;
        btc_storage_set_remote_addr_type(&bd_addr, 0x00);
    }

    btc_read_le_key((1 << 0), sizeof(tBTM_LE_PENC_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);

    btc_read_le_key((1 << 1), sizeof(tBTM_LE_PID_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);

    btc_read_le_key(((1 << 1) << 4), sizeof(tBTM_LE_PID_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);

    btc_read_le_key((1 << 2), sizeof(tBTM_LE_PCSRK_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);

    btc_read_le_key(((1 << 0) << 4), sizeof(tBTM_LE_LENC_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);

    btc_read_le_key(((1 << 2) << 4), sizeof(tBTM_LE_LCSRK_KEYS),
                    bd_addr, addr_type, add, &device_added, &key_found);
...
# 573 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
bt_status_t btc_storage_get_remote_addr_type(bt_bdaddr_t *remote_bd_addr,
                                             int*addr_type)
{
    bdstr_t bdstr;
...
# 607 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                                     1
# 607 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                         ;
        do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s BLE ER key loaded" "\033[0m" "\n", esp_log_timestamp(), "BT",__func__); };} while(0);
    }
...
# 617 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c" 3 4
                                          1
# 617 "/Users/Sentaro/esp/esp-idf/components/bt/bluedroid/btc/core/btc_ble_storage.c"
                                              ;
        do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s BLE ID keys loaded" "\033[0m" "\n", esp_log_timestamp(), "BT", __func__); };} while(0);
    }
                               ...
                               tBTA_BLE_LOCAL_ID_KEYS *p_id_keys)
{
    ...
    do {if (3 >= 4) if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, "BT", "\033[0;" "31" "m" "E" " (%d) %s: " "%s  *p_key_mask=0x%02x" "\033[0m" "\n", esp_log_timestamp(), "BT",__func__, *p_key_mask); };} while(0);
}
