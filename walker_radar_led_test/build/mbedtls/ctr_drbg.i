# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
# 30 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
...
# 31 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 38 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 41 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
...
# 46 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 2
                   ...
                   size_t entropy_len )
{
    ...
    esp_aes_setkey( &ctx->aes_ctx, key, ( 32 * 8 ) );
...
{
    if( ctx == 
# 117 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
              ((void *)0) 
# 117 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                   )
        return;
...
# 168 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
    p = buf + 16;
    *p++ = ( data_len >> 24 ) & 0xff;
    *p++ = ( data_len >> 16 ) & 0xff;
    *p++ = ( data_len >> 8 ) & 0xff;
    ...
    *p++ = ( 32 + 16 );
    ...
    esp_aes_setkey( &aes_ctx, key, ( 32 * 8 ) );
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        ...
        while( use_len > 0 )
        {
            ...
            esp_aes_crypt_ecb( &aes_ctx, 1, chain, chain );
        }
    ...
    esp_aes_setkey( &aes_ctx, tmp, ( 32 * 8 ) );
    iv = tmp + 32;
    p = output;

    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        esp_aes_crypt_ecb( &aes_ctx, 1, iv, iv );
        memcpy( p, iv, 16 );
        p += 16;
    }
                              ...
                              const unsigned char data[( 32 + 16 )] )
{
    ...
    for( j = 0; j < ( 32 + 16 ); j += 16 )
    {
        ...
        esp_aes_crypt_ecb( &ctx->aes_ctx, 1, ctx->counter, p );
    ...
    esp_aes_setkey( &ctx->aes_ctx, tmp, ( 32 * 8 ) );
                              ...
                              const unsigned char *additional, size_t add_len )
{
    ...
    while( output_len > 0 )
    {
        ...
        esp_aes_crypt_ecb( &ctx->aes_ctx, 1, ctx->counter, tmp );
...
# 409 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                                                    ((void *)0)
# 409 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                                                        , 0 );
...
int mbedtls_ctr_drbg_write_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "wb" ) ) == 
# 426 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 426 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
int mbedtls_ctr_drbg_update_seed_file( mbedtls_ctr_drbg_context *ctx, const char *path )
{
    ...
    if( ( f = fopen( path, "rb" ) ) == 
# 451 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
                                      ((void *)0) 
# 451 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
                                           )
        return( -0x003A );
...
# 540 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
int mbedtls_ctr_drbg_self_test( int verbose )
{
    mbedtls_ctr_drbg_context ctx;
...
# 578 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c" 3 4
   ((void *)0)
# 578 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ctr_drbg.c"
