# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/ethernet//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 15 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/esp_eth.h" 1
# 20 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/esp_eth.h"
...
# 17 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2

# 1 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h" 1
# 15 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h"
...
# 22 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h" 2
...
# 49 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h"
void phy_tlk110_power_enable(
# 49 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h" 3 4
                            _Bool
# 49 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h"
                                );
...
# 62 "/Users/Sentaro/esp/esp-idf/components/ethernet/include/eth_phy/phy_tlk110.h"
extern const eth_config_t phy_tlk110_default_ethernet_config;
# 19 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 2
# 54 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
...
eth_speed_mode_t phy_tlk110_get_speed_mode(void)
{
    if((esp_eth_smi_read((0x10)) & (1UL << (1)) ) != (1UL << (1))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_tlk110_get_speed_mode(100)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_SPEED_MODE_100M;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_tlk110_get_speed_mode(10)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
...
eth_duplex_mode_t phy_tlk110_get_duplex_mode(void)
{
    if((esp_eth_smi_read((0x10)) & (1UL << (2)) ) == (1UL << (2))) {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_tlk110_get_duplex_mode(FULL)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_MODE_FULLDUPLEX;
    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_tlk110_get_duplex_mode(HALF)" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        return ETH_MODE_HALFDUPLEX;
    }
}

void phy_tlk110_power_enable(
# 87 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 3 4
                            _Bool 
# 87 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
                                 enable)
{
    if (enable) {
...
void phy_tlk110_init(void)
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "phy_tlk110_init()" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    phy_tlk110_dump_registers();
...
const eth_config_t phy_tlk110_default_ethernet_config = {
    ...
    .flow_ctrl_enable = 
# 126 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c" 3 4
                       1
# 126 "/Users/Sentaro/esp/esp-idf/components/ethernet/eth_phy/phy_tlk110.c"
                           ,
...
void phy_tlk110_dump_registers()
{
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "TLK110 Registers:" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BMCR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x0)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BMSR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHYIDR1  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x2)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHYIDR2  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x3)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ANAR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x4)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ANLPAR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x5)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ANER     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x6)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ANNPTR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x7)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ANLNPTR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x8)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SWSCR1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x9)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SWSCR2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xa)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "SWSCR3   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xb)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "REGCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xd)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ADDAR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xe)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHYSTS   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x10)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHYSCR   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x11)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MISR1    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x12)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "MISR2    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x13)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "FCSCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x14)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "RECR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x15)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BISCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x16)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "RBR      0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x17)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "LEDCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x18)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PHYCR    0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x19)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "10BTSCR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1a)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BICSR1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1b)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "BICSR2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1c)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CDCR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x1e)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "TRXCPSR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x42)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "PWRBOCR  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xae)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "VRCR     0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0xD0)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "ALCDRR1  0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x155)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CDSCR1   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x170)); };
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { esp_log_write(ESP_LOG_DEBUG, TAG, "D" " (%d) %s: " "CDSCR2   0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, esp_eth_smi_read(0x171)); };
}
