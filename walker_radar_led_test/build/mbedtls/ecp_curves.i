# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 2
# 89 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
                           ...
                           const mbedtls_mpi_uint *n, size_t nlen)
{
    ...
    if( a != 
# 586 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
            ((void *)0) 
# 586 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
                 )
...
# 628 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 660 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 704 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
                   ((void *)0)
# 704 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 710 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
                   ((void *)0)
# 710 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 716 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
                   ((void *)0)
# 716 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 722 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
                   ((void *)0)
# 722 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 728 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c" 3 4
                   ((void *)0)
# 728 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 801 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 833 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 905 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 958 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
static int ecp_mod_p224( mbedtls_mpi *N )
{
    ...
    sub32( &cur, N->p[9], &c );; sub32( &cur, N->p[13], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;
    sub32( &cur, N->p[10], &c );; add32( &cur, N->p[7], &c );; add32( &cur, N->p[11], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;
    sub32( &cur, N->p[11], &c );; add32( &cur, N->p[8], &c );; add32( &cur, N->p[12], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;
    sub32( &cur, N->p[12], &c );; add32( &cur, N->p[9], &c );; add32( &cur, N->p[13], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;
    sub32( &cur, N->p[13], &c );; add32( &cur, N->p[10], &c );; N->p[i] = cur;; i++; cur = c > 0 ? c : 0; N->p[i] = cur;; cur = 0; while( ++i < N->n ) { N->p[i] = cur;; } if( c < 0 ) fix_negative( N, c, &C, bits );;
...
static int ecp_mod_p256( mbedtls_mpi *N )
{
    ...
    add32( &cur, N->p[9], &c );; add32( &cur, N->p[10], &c );;
    sub32( &cur, N->p[12], &c );; sub32( &cur, N->p[13], &c );; sub32( &cur, N->p[14], &c );; sub32( &cur, N->p[15], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[10], &c );; add32( &cur, N->p[11], &c );;
    sub32( &cur, N->p[13], &c );; sub32( &cur, N->p[14], &c );; sub32( &cur, N->p[15], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[11], &c );; add32( &cur, N->p[11], &c );; add32( &cur, N->p[12], &c );; add32( &cur, N->p[12], &c );; add32( &cur, N->p[13], &c );;
    sub32( &cur, N->p[15], &c );; sub32( &cur, N->p[8], &c );; sub32( &cur, N->p[9], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[12], &c );; add32( &cur, N->p[12], &c );; add32( &cur, N->p[13], &c );; add32( &cur, N->p[13], &c );; add32( &cur, N->p[14], &c );;
    sub32( &cur, N->p[9], &c );; sub32( &cur, N->p[10], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[13], &c );; add32( &cur, N->p[13], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[15], &c );;
    sub32( &cur, N->p[10], &c );; sub32( &cur, N->p[11], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[14], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[13], &c );;
    sub32( &cur, N->p[8], &c );; sub32( &cur, N->p[9], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[15], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[8], &c );;
    sub32( &cur, N->p[10], &c );; sub32( &cur, N->p[11], &c );; sub32( &cur, N->p[12], &c );; sub32( &cur, N->p[13], &c );; N->p[i] = cur;; i++; cur = c > 0 ? c : 0; N->p[i] = cur;; cur = 0; while( ++i < N->n ) { N->p[i] = cur;; } if( c < 0 ) fix_negative( N, c, &C, bits );;
...
static int ecp_mod_p384( mbedtls_mpi *N )
{
    ...
    add32( &cur, N->p[13], &c );; add32( &cur, N->p[22], &c );; add32( &cur, N->p[23], &c );;
    sub32( &cur, N->p[12], &c );; sub32( &cur, N->p[20], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[14], &c );; add32( &cur, N->p[23], &c );;
    sub32( &cur, N->p[13], &c );; sub32( &cur, N->p[21], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[15], &c );; add32( &cur, N->p[12], &c );; add32( &cur, N->p[20], &c );; add32( &cur, N->p[21], &c );;
    sub32( &cur, N->p[14], &c );; sub32( &cur, N->p[22], &c );; sub32( &cur, N->p[23], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[21], &c );; add32( &cur, N->p[21], &c );; add32( &cur, N->p[16], &c );; add32( &cur, N->p[13], &c );; add32( &cur, N->p[12], &c );; add32( &cur, N->p[20], &c );; add32( &cur, N->p[22], &c );;
    sub32( &cur, N->p[15], &c );; sub32( &cur, N->p[23], &c );; sub32( &cur, N->p[23], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[22], &c );; add32( &cur, N->p[22], &c );; add32( &cur, N->p[17], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[13], &c );; add32( &cur, N->p[21], &c );; add32( &cur, N->p[23], &c );;
    sub32( &cur, N->p[16], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[23], &c );; add32( &cur, N->p[23], &c );; add32( &cur, N->p[18], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[14], &c );; add32( &cur, N->p[22], &c );;
    sub32( &cur, N->p[17], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[19], &c );; add32( &cur, N->p[16], &c );; add32( &cur, N->p[15], &c );; add32( &cur, N->p[23], &c );;
    sub32( &cur, N->p[18], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[20], &c );; add32( &cur, N->p[17], &c );; add32( &cur, N->p[16], &c );;
    sub32( &cur, N->p[19], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[21], &c );; add32( &cur, N->p[18], &c );; add32( &cur, N->p[17], &c );;
    sub32( &cur, N->p[20], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[22], &c );; add32( &cur, N->p[19], &c );; add32( &cur, N->p[18], &c );;
    sub32( &cur, N->p[21], &c );; N->p[i] = cur;; i++; cur = N->p[i];; cc = c; c = 0; if( cc < 0 ) sub32( &cur, -cc, &c ); else add32( &cur, cc, &c );;

    add32( &cur, N->p[23], &c );; add32( &cur, N->p[20], &c );; add32( &cur, N->p[19], &c );;
    sub32( &cur, N->p[22], &c );; N->p[i] = cur;; i++; cur = c > 0 ? c : 0; N->p[i] = cur;; cur = 0; while( ++i < N->n ) { N->p[i] = cur;; } if( c < 0 ) fix_negative( N, c, &C, bits );;

cleanup:
    return( ret );
}
# 1116 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 1165 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 1212 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 1286 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
...
# 1319 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/ecp_curves.c"
