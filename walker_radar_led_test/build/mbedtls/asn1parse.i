# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/mbedtls//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
# 25 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
...
# 26 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 2
...
# 31 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 2
...
# 33 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 2
...
# 36 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 2
...
# 40 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 2
    ...
    while( *p < end )
    {
        ...
        *p += buf->len;
        ...
        if( *p < end )
        {
            ...
            if( cur->next == 
# 275 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 3 4
                            ((void *)0) 
# 275 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
                                 )
                return( -0x006A );
    ...
    cur->next = 
# 283 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 3 4
               ((void *)0)
# 283 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
                   ;
...
{
    if( cur == 
# 355 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 3 4
              ((void *)0) 
# 355 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
                   )
        return;
...
void mbedtls_asn1_free_named_data_list( mbedtls_asn1_named_data **head )
{
    ...
    while( ( cur = *head ) != 
# 368 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 3 4
                             ((void *)0) 
# 368 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
                                  )
    {
        *head = cur->next;
...
{
    while( list != 
# 379 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c" 3 4
                  ((void *)0) 
# 379 "/Users/Sentaro/esp/esp-idf/components/mbedtls/library/asn1parse.c"
                       )
    {
        if( list->oid.len == len &&
