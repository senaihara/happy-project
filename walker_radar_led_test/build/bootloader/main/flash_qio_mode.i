# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bootloader/main//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
...
# 15 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 17 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 47 "/Users/Sentaro/esp/xtensa-esp32-elf/xtensa-esp32-elf/include/stdio.h" 3
...
# 19 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/rom/spi_flash.h" 1
# 21 "/Users/Sentaro/esp/esp-idf/components/esp32/include/rom/spi_flash.h"
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 22 "/Users/Sentaro/esp/esp-idf/components/esp32/include/rom/spi_flash.h" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 21 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/soc/esp32/include/soc/efuse_reg.h" 1
# 23 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/bootloader/../include/sdkconfig.h" 1
# 24 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 2
# 39 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
...
# 86 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
const static qio_info_t chip_data[] = {
    ...
    { 
# 99 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c" 3 4
     ((void *)0)
# 99 "/Users/Sentaro/esp/esp-idf/components/bootloader/subproject/main/./flash_qio_mode.c"
...
void bootloader_enable_qio_mode(void)
{
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Probing for QIO mode enable..." "\033[0m" "\n", esp_log_timestamp(), TAG); };
    esp_rom_spiflash_wait_idle(&g_rom_flashchip);



    old_ctrl_reg = SPI1.ctrl.val;
    ...
    raw_flash_id = execute_flash_command(0x9F, 0, 0, 24);
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Raw SPI flash chip id 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, raw_flash_id); };

    mfg_id = raw_flash_id & 0xFF;
    flash_id = (raw_flash_id >> 16) | (raw_flash_id & 0xFF00);
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Manufacturer ID 0x%02x chip ID 0x%04x" "\033[0m" "\n", esp_log_timestamp(), TAG, mfg_id, flash_id); };
    ...
    for (i = 0; i < (sizeof(chip_data) / sizeof(qio_info_t))-1; i++) {
        ...
        if (mfg_id == chip->mfg_id && (flash_id & chip->id_mask) == (chip->flash_id & chip->id_mask)) {
            if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Enabling QIO for flash chip %s" "\033[0m" "\n", esp_log_timestamp(), TAG, chip_data[i].manufacturer); };
            break;
        }
    }

    if (i == (sizeof(chip_data) / sizeof(qio_info_t)) - 1) {
        if (((esp_log_level_t) 3) >= ESP_LOG_INFO) { ets_printf("\033[0;" "32" "m" "I" " (%d) %s: " "Enabling default flash chip QIO" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    }
                            ...
                            uint8_t status_qio_bit)
{
    ...
    if (spiconfig != 0 && spiconfig != 1) {
        ...
        uint32_t chip_ver = ({ ; ((({ ; (*(volatile uint32_t *)((0x3ff5A000 + 0x00c))); }) >> (12)) & (0x7)); });
        uint32_t pkg_ver = chip_ver & 0x7;
        const int PKG_VER_ESP32_D2WD = 2;
        if (pkg_ver == PKG_VER_ESP32_D2WD && 7 != 7) {
            if (((esp_log_level_t) 3) >= ESP_LOG_WARN) { ets_printf("\033[0;" "33" "m" "W" " (%d) %s: " "Chip is ESP32-D2WD but flash WP pin is different value to internal flash" "\033[0m" "\n", esp_log_timestamp(), TAG); };
        }
    }
    ...
    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Initial flash chip status 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, status); };
    ...
    if ((status & (1<<status_qio_bit)) == 0) {
        ...
        status = read_status_fn();
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Updated flash chip status 0x%x" "\033[0m" "\n", esp_log_timestamp(), TAG, status); };
        if ((status & (1<<status_qio_bit)) == 0) {
            if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { ets_printf("\033[0;" "31" "m" "E" " (%d) %s: " "Failed to set QIE bit, not enabling QIO mode" "\033[0m" "\n", esp_log_timestamp(), TAG); };
            return -1;
        }

    } else {
        if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "QIO mode already enabled in flash" "\033[0m" "\n", esp_log_timestamp(), TAG); };
    }

    if (((esp_log_level_t) 3) >= ESP_LOG_DEBUG) { ets_printf( "D" " (%d) %s: " "Enabling QIO mode..." "\033[0m" "\n", esp_log_timestamp(), TAG); };
