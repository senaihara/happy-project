...
.LC1:
	...
	.align	4
.LC4:
	.string	"/Users/Sentaro/esp/esp-idf/components/lwip/core/tcp_out.c"
	.align	4
.LC6:
...
tcp_write_checks:
.LFB13:
	.file 1 "/Users/Sentaro/esp/esp-idf/components/lwip/core/tcp_out.c"
	.loc 1 313 0
.LVL0:
	entry	sp, 32
.LCFI0:
...
.L32:
.LVL68:
	.loc 1 1198 0 is_stmt 1 discriminator 6
	beqz.n	a5, .L45
	.loc 1 1203 0
	beqz.n	a3, .L34
	...
	beqz.n	a3, .L46
	.loc 1 1203 0 is_stmt 0 discriminator 6
	l32i.n	a6, a3, 0
	bnez.n	a6, .L47
	.loc 1 1203 0 discriminator 7
	l32i.n	a6, a3, 4
	bnez.n	a6, .L48
	.loc 1 1203 0 discriminator 9
	l32i.n	a6, a3, 8
	bnez.n	a6, .L49
	.loc 1 1203 0 discriminator 11
	l32i.n	a6, a3, 12
	beqz.n	a6, .L50
	.loc 1 1203 0
	movi.n	a6, 0
...
.L34:
	...
	beqz.n	a3, .L51
	.loc 1 1203 0 is_stmt 0 discriminator 19
	l32i.n	a6, a3, 0
	bnez.n	a6, .L52
	.loc 1 1203 0
	movi.n	a6, 1
...
.L52:
	movi.n	a6, 0
.L36:
	.loc 1 1203 0 is_stmt 1 discriminator 24
	beqz.n	a6, .L38
.LBB3:
	.loc 1 1204 0
	beqz.n	a4, .L39
	...
	beqz.n	a5, .L53
	.loc 1 1204 0 is_stmt 0 discriminator 5
	addi	a11, a3, 20
	mov.n	a10, a5
...
.LVL69:
	j	.L40
.L39:
	.loc 1 1204 0 is_stmt 1 discriminator 4
	beqz.n	a5, .L54
	.loc 1 1204 0 is_stmt 0 discriminator 10
	addi.n	a10, a5, 4
	j	.L40
.L53:
...
.LVL75:
	...
	l8ui	a4, a3, 36
	bnei	a4, 6, .L43
	.loc 1 1269 0 is_stmt 0 discriminator 3
	l32i.n	a10, a2, 4
	l8ui	a13, a3, 42
	l8ui	a14, a3, 41
	.loc 1 1269 0 is_stmt 1 discriminator 3
	s32i.n	a5, sp, 0
	movi.n	a15, 6
	addi	a12, a3, 20
	mov.n	a11, a3
...
.L185:
.LVL314:
	.loc 1 1338 0 is_stmt 1 discriminator 6
	beqz.n	a2, .L186
	.loc 1 1341 0
	mov.n	a14, a5
	mov.n	a13, a4
...
.L207:
.LVL340:
	.loc 1 1511 0 is_stmt 1 discriminator 6
	beqz.n	a5, .L211
.LBB15:
	.loc 1 1516 0
	l32i.n	a6, a3, 4
...
.LBE15:
	...
	l8ui	a4, a2, 36
	bnei	a4, 6, .L209
	.loc 1 1525 0 is_stmt 0 discriminator 3
	l8ui	a13, a2, 42
...
.L224:
	movi.n	a5, 1
.L215:
	.loc 1 1574 0 discriminator 6
	extui	a5, a5, 0, 8
.LVL357:
	.loc 1 1576 0 is_stmt 1 discriminator 6
	movi.n	a11, 0
	movi.n	a12, 1
	movnez	a12, a11, a5
.LVL358:
	.loc 1 1578 0 discriminator 6
	l32i.n	a7, a3, 16
	l8ui	a9, a7, 4
	l8ui	a4, a7, 5
	slli	a4, a4, 8
...
.L219:
.LVL371:
	.loc 1 1598 0 is_stmt 1 discriminator 6
	beqz.n	a3, .L226
	.loc 1 1603 0
	mov.n	a14, a6
	mov.n	a13, a2
...
.LVL372:
	...
	l8ui	a5, a2, 36
	bnei	a5, 6, .L221
	.loc 1 1611 0 is_stmt 0 discriminator 3
	l8ui	a13, a2, 42
	.loc 1 1611 0 is_stmt 1 discriminator 3
	s32i.n	a3, sp, 0
	movi.n	a15, 6
	movi.n	a14, 0
	addi	a12, a2, 20
...
.LFE24:
	...
	.section	.rodata.__func__$6306,"a",@progbits
	.align	4
	.type	__func__$6306, @object
	.size	__func__$6306, 8
__func__$6306:
	.string	"tcp_rst"
...
__func__$6271:
	.string	"tcp_output"
	.section	.rodata.__func__$6145,"a",@progbits
	.align	4
	.type	__func__$6145, @object
	.size	__func__$6145, 24
__func__$6145:
	.string	"tcp_output_alloc_header"
	.section	.rodata.__func__$6244,"a",@progbits
	.align	4
	.type	__func__$6244, @object
	.size	__func__$6244, 18
__func__$6244:
	.string	"tcp_enqueue_flags"
	.section	.rodata.__func__$6163,"a",@progbits
	.align	4
	.type	__func__$6163, @object
	.size	__func__$6163, 19
__func__$6163:
	.string	"tcp_create_segment"
	.section	.rodata.__func__$6176,"a",@progbits
	.align	4
	.type	__func__$6176, @object
	.size	__func__$6176, 18
__func__$6176:
...
.Letext0:
	...
	.file 11 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/memp.h"
	.file 12 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/priv/memp_priv.h"
	.file 13 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/tcp.h"
	.file 14 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/priv/tcp_priv.h"
	...
	.file 17 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/def.h"
	.file 18 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/ip6.h"
	.file 19 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/ip4.h"
	.file 20 "/Users/Sentaro/esp/esp-idf/components/lwip/include/lwip/lwip/inet_chksum.h"
