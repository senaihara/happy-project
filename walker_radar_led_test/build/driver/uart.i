# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/driver//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
# 14 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
...
# 15 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 16 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_attr.h" 1
# 17 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 18 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
# 1 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_intr_alloc.h" 1
# 20 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_intr_alloc.h"
...
# 21 "/Users/Sentaro/esp/esp-idf/components/esp32/include/esp_intr_alloc.h" 2
...
# 19 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 20 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 22 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 23 "/Users/Sentaro/esp/esp-idf/components/driver/include/driver/touch_pad.h"
...
# 23 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 26 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 27 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 28 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 29 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2
...
# 30 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 2


static const char* UART_TAG = "uart";
# 47 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
typedef struct {
    uart_event_type_t type;
    struct {
        int brk_len;
...
# 66 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   _Bool 
# 66 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
        rx_buffer_full_flg;
    int rx_cur_remain;
    uint8_t* rx_ptr;
    uint8_t* rx_head_ptr;
...
# 79 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   _Bool 
# 79 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
        tx_waiting_fifo;
    uint8_t* tx_ptr;
...
esp_err_t uart_get_word_length(uart_port_t uart_num, uart_word_length_t* data_bit)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 108, "uart_num error"); }; return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 115, "uart_num error"); }; return (-1); };
    if (!((stop_bit < UART_STOP_BITS_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 116, "stop bit error"); }; return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 133, "uart_num error"); }; return (-1); };
...
esp_err_t uart_set_parity(uart_port_t uart_num, uart_parity_t parity_mode)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 145, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_get_parity(uart_port_t uart_num, uart_parity_t* parity_mode)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 155, "uart_num error"); }; return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 171, "uart_num error"); }; return (-1); };
    if (!((baud_rate <= 5000000))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 172, "baud_rate error"); }; return (-1); };
...
esp_err_t uart_get_baudrate(uart_port_t uart_num, uint32_t* baudrate)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 183, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_set_line_inverse(uart_port_t uart_num, uint32_t inverse_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 193, "uart_num error"); }; return (-1); };
    if (!((((inverse_mask & ~(0x3f << 19)) == 0) || (inverse_mask == 0)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 194, "inverse_mask error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), 1), "(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)"); (("(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 196, __func__, "\"(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC)), (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 196, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 196, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))); })&(~((0x3f << 19))))); }); });
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)"); (("(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 197, __func__, "\"(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC)), (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 197, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 197, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x20)))); })|(inverse_mask))); }); });
    vTaskExitCritical(&uart_spinlock[uart_num]);
    return 0;
}
...
esp_err_t uart_get_hw_flow_ctrl(uart_port_t uart_num, uart_hw_flowcontrol_t* flow_ctrl)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 226, "uart_num error"); }; return (-1); };
...
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 240, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_clear_intr_status(uart_port_t uart_num, uint32_t clr_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 252, "uart_num error"); }; return (-1); };
...
esp_err_t uart_enable_intr_mask(uart_port_t uart_num, uint32_t enable_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 260, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)"); (("(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 262, __func__, "\"(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) <= 0x3ff03FFC)), (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 262, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 262, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x10)))); })|(enable_mask))); }); });
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), 1), "(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)"); (("(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 263, __func__, "\"(Cannot use SET_PERI_REG_MASK for DPORT registers use DPORT_SET_PERI_REG_MASK)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC)), (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 263, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 263, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))); })|(enable_mask))); }); });
    vTaskExitCritical(&uart_spinlock[uart_num]);
    return 0;
}
...
esp_err_t uart_disable_intr_mask(uart_port_t uart_num, uint32_t disable_mask)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 270, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), 1), "(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)"); (("(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 272, __func__, "\"(Cannot use CLEAR_PERI_REG_MASK for DPORT registers use DPORT_CLEAR_PERI_REG_MASK)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))")); } while(0);; ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC)), (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 272, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!(((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) >= 0x3ff00000) && (((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))))) = (uint32_t)((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC)), 1), "(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)"); (("(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 272, __func__, "\"(Cannot use READ_PERI_REG for DPORT registers use DPORT_READ_PERI_REG)\" && (!((((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) >= 0x3ff00000) && ((((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x3ff40000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0xC)))); })&(~(disable_mask)))); }); });
    vTaskExitCritical(&uart_spinlock[uart_num]);
    return 0;
}
...
esp_err_t uart_enable_tx_intr(uart_port_t uart_num, int enable, int thresh)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 313, "uart_num error"); }; return (-1); };
    if (!((thresh < (128)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 314, "empty intr threshold error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
{
    int ret;
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 326, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    switch(uart_num) {
        case UART_NUM_1:
...
{
    esp_err_t ret;
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 348, "uart_num error"); }; return (-1); };
    if (p_uart_obj[uart_num]->intr_handle==
# 349 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                          ((void *)0)
# 349 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              ) return 0x102;
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    ret=esp_intr_free(p_uart_obj[uart_num]->intr_handle);
    p_uart_obj[uart_num]->intr_handle=
# 352 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                     ((void *)0)
# 352 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                         ;
    vTaskExitCritical(&uart_spinlock[uart_num]);
    return ret;
}
...
esp_err_t uart_set_pin(uart_port_t uart_num, int tx_io_num, int rx_io_num, int rts_io_num, int cts_io_num)
{
    ...
    if(tx_io_num >= 0) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 396, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[tx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[tx_io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[tx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[tx_io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((GPIO_PIN_MUX_REG[tx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[tx_io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 396, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((GPIO_PIN_MUX_REG[tx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[tx_io_num]))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[tx_io_num]))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 396, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((GPIO_PIN_MUX_REG[tx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[tx_io_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[tx_io_num])); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
        gpio_set_level(tx_io_num, 1);
        gpio_matrix_out(tx_io_num, tx_sig, 0, 0);
    }

    if(rx_io_num >= 0) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 402, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[rx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rx_io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[rx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rx_io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((GPIO_PIN_MUX_REG[rx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rx_io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 402, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((GPIO_PIN_MUX_REG[rx_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rx_io_num]))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[rx_io_num]))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 402, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((GPIO_PIN_MUX_REG[rx_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rx_io_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[rx_io_num])); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
        gpio_set_pull_mode(rx_io_num, GPIO_PULLUP_ONLY);
        gpio_set_direction(rx_io_num, GPIO_MODE_INPUT);
        gpio_matrix_in(rx_io_num, rx_sig, 0);
    }
    if(rts_io_num >= 0) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 408, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[rts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rts_io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[rts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rts_io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((GPIO_PIN_MUX_REG[rts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rts_io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 408, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((GPIO_PIN_MUX_REG[rts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[rts_io_num]))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[rts_io_num]))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 408, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((GPIO_PIN_MUX_REG[rts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[rts_io_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[rts_io_num])); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
        gpio_set_direction(rts_io_num, GPIO_MODE_OUTPUT);
        gpio_matrix_out(rts_io_num, rts_sig, 0, 0);
    }
    if(cts_io_num >= 0) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)"); (("(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)" && (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 413, __func__, "\"(Cannot use REG_SET_FIELD for DPORT registers use DPORT_REG_SET_FIELD)\" && (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC))")); } while(0);; (({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!(((((GPIO_PIN_MUX_REG[cts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[cts_io_num]))) <= 0x3ff03FFC)), (!(((((GPIO_PIN_MUX_REG[cts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[cts_io_num]))) <= 0x3ff03FFC)), 1), "(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)"); (("(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)" && (!(((((GPIO_PIN_MUX_REG[cts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[cts_io_num]))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 413, __func__, "\"(Cannot use REG_WRITE for DPORT registers use DPORT_REG_WRITE)\" && (!(((((GPIO_PIN_MUX_REG[cts_io_num]))) >= 0x3ff00000) && (((GPIO_PIN_MUX_REG[cts_io_num]))) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)((GPIO_PIN_MUX_REG[cts_io_num]))) = (((({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC)), (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC)), 1), "(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)"); (("(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)" && (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 413, __func__, "\"(Cannot use REG_READ for DPORT registers use DPORT_REG_READ)\" && (!((((GPIO_PIN_MUX_REG[cts_io_num])) >= 0x3ff00000) && ((GPIO_PIN_MUX_REG[cts_io_num])) <= 0x3ff03FFC))")); } while(0);; (*(volatile uint32_t *)(GPIO_PIN_MUX_REG[cts_io_num])); }) & ~((0x7) << (12)))|(((2) & (0x7))<<(12)))); })); });
...
esp_err_t uart_set_rts(uart_port_t uart_num, int level)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 423, "uart_num error"); }; return (-1); };
    if (!((UART[uart_num]->conf1.rx_flow_en != 1))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 424, "disable hw flowctrl before using sw control"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_set_dtr(uart_port_t uart_num, int level)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 433, "uart_num error"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
{
    esp_err_t r;
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 443, "uart_num error"); }; return (-1); };
    if (!((uart_config))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 444, "param null"); }; return (-1); };
...
esp_err_t uart_intr_config(uart_port_t uart_num, const uart_intr_config_t *intr_conf)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 468, "uart_num error"); }; return (-1); };
    if (!((intr_conf))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 469, "param null"); }; return (-1); };
    vTaskEnterCritical(&uart_spinlock[uart_num]);
...
# 513 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                         1 
# 513 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              && p_uart->tx_buf_size == 0) {
                p_uart->tx_waiting_fifo = 
# 514 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                         0
# 514 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              ;
...
# 526 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
               _Bool 
# 526 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                    en_tx_flg = 
# 526 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                0
# 526 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
...
# 531 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                                   ((void *)0) 
# 531 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                                        || p_uart->tx_len_cur == 0) {
                        size_t size;
                        ...
                        if(p_uart->tx_head) {
                            ...
                            if(p_uart->tx_len_tot == 0) {
                                p_uart->tx_ptr = 
# 538 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                ((void *)0)
# 538 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                    ;
...
# 550 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                      ((void *)0)
# 550 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                          ) {

                                p_uart->tx_ptr = (uint8_t*) p_uart->tx_head;
                                en_tx_flg = 
# 553 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           1
# 553 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
                    ...
                    if(p_uart->tx_len_tot > 0 && p_uart->tx_ptr && p_uart->tx_len_cur > 0) {
                        ...
                        for(buf_idx = 0; buf_idx < send_len; buf_idx++) {
                            ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC)), (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 566, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0)))) = (uint32_t)(*(p_uart->tx_ptr++) & 0xff); });
                        }
                        ...
                        if(p_uart->tx_len_cur == 0) {
                            ...
                            p_uart->tx_head = 
# 577 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                             ((void *)0)
# 577 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                 ;
                            p_uart->tx_ptr = 
# 578 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                            ((void *)0)
# 578 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                ;
                            ...
                            if(p_uart->tx_brk_flg == 1 && p_uart->tx_len_tot == 0) {
                                ...
                                en_tx_flg = 
# 592 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           1
# 592 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
                            }
                        } else {

                            en_tx_flg = 
# 596 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                       1
# 596 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                           ;
                        }
                    }
                }
...
# 609 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                            0
# 609 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                 ) {
...
# 630 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                1
# 630 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                    ;
...
esp_err_t uart_wait_tx_done(uart_port_t uart_num, TickType_t ticks_to_wait)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 718, "uart_num error"); }; return (-1); };
    if (!((p_uart_obj[uart_num]))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 719, "uart driver error"); }; return (-1); };
    BaseType_t res;
    TickType_t ticks_end = xTaskGetTickCount() + ticks_to_wait;

    res = xQueueGenericReceive( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 723 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
         ((void *)0)
# 723 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
...
# 728 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 728 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( 0 ), ( ( BaseType_t ) 0 ) );
    ticks_to_wait = ticks_end - xTaskGetTickCount();
    if(UART[uart_num]->status.txfifo_cnt == 0) {
        xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 731 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
       ((void *)0)
# 731 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
...
# 736 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
         ((void *)0)
# 736 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
         , ( (TickType_t)ticks_to_wait ), ( ( BaseType_t ) 0 ) );
    if(res == ( ( BaseType_t ) 0 )) {
        uart_disable_intr_mask(uart_num, ((1UL << (14))));
        xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 739 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
       ((void *)0)
# 739 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
        return 0x107;
    }
    xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 742 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 742 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return 0;
}
...
static int uart_fill_fifo(uart_port_t uart_num, const char* buffer, uint32_t len)
{
    ...
    for(i = 0; i < copy_cnt; i++) {
        ({ do { _Static_assert(__builtin_choose_expr(__builtin_constant_p(!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC)), (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC)), 1), "(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)"); (("(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)" && (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC))) ? (void)0 : __assert_func ("/Users/Sentaro/esp/esp-idf/components/driver/./uart.c", 766, __func__, "\"(Cannot use WRITE_PERI_REG for DPORT registers use DPORT_WRITE_PERI_REG)\" && (!((((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) >= 0x3ff00000) && ((((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0))) <= 0x3ff03FFC))")); } while(0);; (*((volatile uint32_t *)(((0x60000000 + (uart_num) * 0x10000 + ( (uart_num) > 1 ? 0xe000 : 0 ) ) + 0x0)))) = (uint32_t)(buffer[i]); });
    }
    return copy_cnt;
}
...
int uart_tx_chars(uart_port_t uart_num, const char* buffer, uint32_t len)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 773, "uart_num error"); }; return ((-1)); };
    if (!((p_uart_obj[uart_num]))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 774, "uart driver error"); }; return ((-1)); };
    if (!(buffer)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 775, "buffer null"); }; return ((-1)); };
    if(len == 0) {
        return 0;
    }
    xQueueGenericReceive( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 779 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 779 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( (TickType_t)( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    int tx_len = uart_fill_fifo(uart_num, (const char*) buffer, len);
    xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 781 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 781 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return tx_len;
}

static int uart_tx_all(uart_port_t uart_num, const char* src, size_t size, 
# 785 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                                          _Bool 
# 785 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                                               brk_en, int brk_len)
{
    if(size == 0) {
        return 0;
    ...
    xQueueGenericReceive( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 793 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 793 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( (TickType_t)( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    if(p_uart_obj[uart_num]->tx_buf_size > 0) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 813 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
       ((void *)0)
# 813 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    } else {
        while(size) {

            if(( ( BaseType_t ) 1 ) == xQueueGenericReceive( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_fifo_sem ), 
# 817 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                        ((void *)0)
# 817 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                        , ( (TickType_t)( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) )) {
                size_t sent = uart_fill_fifo(uart_num, (char*) src, size);
                if(sent < size) {
                    p_uart_obj[uart_num]->tx_waiting_fifo = 
# 820 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                           1
# 820 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                               ;
                    uart_enable_tx_intr(uart_num, 1, (10));
                }
                size -= sent;
...
# 829 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
           ((void *)0)
# 829 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
           , ( (TickType_t)( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
        }
        xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_fifo_sem ), 
# 831 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
       ((void *)0)
# 831 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    }
    xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ), 
# 833 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 833 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
int uart_write_bytes(uart_port_t uart_num, const char* src, size_t size)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 839, "uart_num error"); }; return ((-1)); };
    if (!((p_uart_obj[uart_num] != 
# 840 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 840 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   ))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 840, "uart driver error"); }; return ((-1)); };
    if (!(src)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 841, "buffer null"); }; return ((-1)); };
    return uart_tx_all(uart_num, src, size, 0, 0);
}

int uart_write_bytes_with_break(uart_port_t uart_num, const char* src, size_t size, int brk_len)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 847, "uart_num error"); }; return ((-1)); };
    if (!((p_uart_obj[uart_num]))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 848, "uart driver error"); }; return ((-1)); };
    if (!((size > 0))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 849, "uart size error"); }; return ((-1)); };
    if (!((src))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 850, "uart data null"); }; return ((-1)); };
    if (!((brk_len > 0 && brk_len < 256))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 851, "break_num error"); }; return ((-1)); };
    return uart_tx_all(uart_num, src, size, 1, brk_len);
}

int uart_read_bytes(uart_port_t uart_num, uint8_t* buf, uint32_t length, TickType_t ticks_to_wait)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 857, "uart_num error"); }; return ((-1)); };
    ...
    uint8_t* data = 
# 860 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                   ((void *)0)
# 860 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                       ;
    size_t size;
    size_t copy_len = 0;
    int len_tmp;
    if(xQueueGenericReceive( ( QueueHandle_t ) ( p_uart_obj[uart_num]->rx_mux ), 
# 864 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
      ((void *)0)
# 864 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
...
# 875 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
               ((void *)0)
# 875 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
               , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
                vTaskEnterCritical(&uart_spinlock[uart_num]);
...
# 894 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                               ((void *)0)
# 894 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                   ;
            p_uart_obj[uart_num]->rx_ptr = 
# 895 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                          ((void *)0)
# 895 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              ;
...
# 902 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                              0
# 902 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                                   ;
    ...
    xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->rx_mux ), 
# 908 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 908 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    vTaskEnterCritical(&uart_spinlock[uart_num]);
    p_uart_obj[uart_num]->rx_buffered_len -= copy_len;
    vTaskExitCritical(&uart_spinlock[uart_num]);
...
esp_err_t uart_get_buffered_data_len(uart_port_t uart_num, size_t* size)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 917, "uart_num error"); }; return (-1); };
    if (!((p_uart_obj[uart_num]))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 918, "uart driver error"); }; return (-1); };
...
esp_err_t uart_flush(uart_port_t uart_num)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 925, "uart_num error"); }; return (-1); };
    if (!((p_uart_obj[uart_num]))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 926, "uart driver error"); }; return (-1); };
...
# 932 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 932 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( (TickType_t)( TickType_t ) 0xffffffffUL ), ( ( BaseType_t ) 0 ) );
    uart_disable_rx_intr(p_uart_obj[uart_num]->uart_num);
    while(
# 934 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
         1
# 934 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
             ) {
        if(p_uart->rx_head_ptr) {
            ...
            vTaskExitCritical(&uart_spinlock[uart_num]);
            p_uart->rx_ptr = 
# 940 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                            ((void *)0)
# 940 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                ;
            p_uart->rx_cur_remain = 0;
            p_uart->rx_head_ptr = 
# 942 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                 ((void *)0)
# 942 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                     ;
        }
        data = (uint8_t*) xRingbufferReceive(p_uart->rx_ring_buf, &size, (TickType_t) 0);
        if(data == 
# 945 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                  ((void *)0)
# 945 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                      ) {
            break;
        }
        vTaskEnterCritical(&uart_spinlock[uart_num]);
        ...
        if(p_uart_obj[uart_num]->rx_buffer_full_flg) {
            ...
            if(res == ( ( BaseType_t ) 1 )) {
                ...
                vTaskExitCritical(&uart_spinlock[uart_num]);
                p_uart_obj[uart_num]->rx_buffer_full_flg = 
# 958 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                          0
# 958 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                               ;
            }
        }
    }
    p_uart->rx_ptr = 
# 962 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                    ((void *)0)
# 962 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                        ;
    p_uart->rx_cur_remain = 0;
    p_uart->rx_head_ptr = 
# 964 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                         ((void *)0)
# 964 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                             ;
    uart_reset_fifo(uart_num);
    uart_enable_rx_intr(p_uart_obj[uart_num]->uart_num);
    xQueueGenericSend( ( QueueHandle_t ) ( p_uart->rx_mux ), 
# 967 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
   ((void *)0)
# 967 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
   , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
    return 0;
}
...
{
    esp_err_t r;
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 974, "uart_num error"); }; return (-1); };
    if (!((rx_buffer_size > (128)))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 975, "uart rx buffer length error(>128)"); }; return (-1); };
    if (!((tx_buffer_size > (128)) || (tx_buffer_size == 0))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 976, "uart tx buffer length error(>128 or 0)"); }; return (-1); };
    if (!((intr_alloc_flags & (1<<10)) == 0)) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 977, "ESP_INTR_FLAG_IRAM set in intr_alloc_flags"); }; return (-1); };

    if(p_uart_obj[uart_num] == 
# 979 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                              ((void *)0)
# 979 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                  ) {
        p_uart_obj[uart_num] = (uart_obj_t*) malloc(sizeof(uart_obj_t));
        if(p_uart_obj[uart_num] == 
# 981 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                  ((void *)0)
# 981 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                      ) {
        ...
        xQueueGenericSend( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_fifo_sem ), 
# 987 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
       ((void *)0)
# 987 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
       , ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) );
...
# 993 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                      ((void *)0)
# 993 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                          ;
        p_uart_obj[uart_num]->tx_head = 
# 994 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                       ((void *)0)
# 994 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                           ;
...
# 1006 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                              ((void *)0)
# 1006 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                  ;
        }
        p_uart_obj[uart_num]->rx_buffer_full_flg = 
# 1008 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                                  0
# 1008 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                       ;
        p_uart_obj[uart_num]->tx_waiting_fifo = 
# 1009 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                               0
# 1009 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                    ;
        p_uart_obj[uart_num]->rx_ptr = 
# 1010 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                      ((void *)0)
# 1010 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                          ;
        p_uart_obj[uart_num]->rx_cur_remain = 0;
        p_uart_obj[uart_num]->rx_head_ptr = 
# 1012 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           ((void *)0)
# 1012 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
...
# 1018 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                               ((void *)0)
# 1018 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                                   ;
...
esp_err_t uart_driver_delete(uart_port_t uart_num)
{
    if (!((uart_num < UART_NUM_MAX))) { if (((esp_log_level_t) 3) >= ESP_LOG_ERROR) { esp_log_write(ESP_LOG_ERROR, UART_TAG, "\033[0;" "31" "m" "E" " (%d) %s: " "%s(%d): %s" "\033[0m" "\n", esp_log_timestamp(), UART_TAG, __FUNCTION__, 1051, "uart_num error"); }; return (-1); };
    if(p_uart_obj[uart_num] == 
# 1052 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                              ((void *)0)
# 1052 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                  ) {
...
# 1062 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           ((void *)0)
# 1062 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
    }
...
# 1066 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           ((void *)0)
# 1066 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
    }
    if(p_uart_obj[uart_num]->tx_brk_sem) {
        vQueueDelete( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_brk_sem ) );
        p_uart_obj[uart_num]->tx_brk_sem = 
# 1070 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                          ((void *)0)
# 1070 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              ;
    }
    if(p_uart_obj[uart_num]->tx_mux) {
        vQueueDelete( ( QueueHandle_t ) ( p_uart_obj[uart_num]->tx_mux ) );
        p_uart_obj[uart_num]->tx_mux = 
# 1074 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                      ((void *)0)
# 1074 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                          ;
    }
    if(p_uart_obj[uart_num]->rx_mux) {
        vQueueDelete( ( QueueHandle_t ) ( p_uart_obj[uart_num]->rx_mux ) );
        p_uart_obj[uart_num]->rx_mux = 
# 1078 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                      ((void *)0)
# 1078 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                          ;
    }
    if(p_uart_obj[uart_num]->xQueueUart) {
        vQueueDelete(p_uart_obj[uart_num]->xQueueUart);
        p_uart_obj[uart_num]->xQueueUart = 
# 1082 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                          ((void *)0)
# 1082 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                              ;
    }
    if(p_uart_obj[uart_num]->rx_ring_buf) {
        vRingbufferDelete(p_uart_obj[uart_num]->rx_ring_buf);
        p_uart_obj[uart_num]->rx_ring_buf = 
# 1086 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           ((void *)0)
# 1086 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
    }
    if(p_uart_obj[uart_num]->tx_ring_buf) {
        vRingbufferDelete(p_uart_obj[uart_num]->tx_ring_buf);
        p_uart_obj[uart_num]->tx_ring_buf = 
# 1090 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                                           ((void *)0)
# 1090 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                                               ;
    }

    free(p_uart_obj[uart_num]);
    p_uart_obj[uart_num] = 
# 1094 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c" 3 4
                          ((void *)0)
# 1094 "/Users/Sentaro/esp/esp-idf/components/driver/./uart.c"
                              ;
    return 0;
}
