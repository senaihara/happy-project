# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
# 1 "/Users/Sentaro/GitHub/happy-project/walker_radar_led_test/build/fatfs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
# 22 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
...
# 23 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c" 2
...
# 24 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c" 2
# 526 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static FATFS *FatFs[2];
static WORD Fsid;
# 602 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
...
# 643 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
...
# 682 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
...
# 727 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
int lock_fs (
 FATFS* fs
)
...
# 868 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT sync_window (
 FATFS* fs
)
...
# 929 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT sync_fs (
 FATFS* fs
)
...
# 968 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
DWORD clust2sect (
 FATFS* fs,
 DWORD clst
...
# 986 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
DWORD get_fat (
 _FDID* obj,
 DWORD clst
)
{
 ...
 if (clst < 2 || clst >= fs->n_fatent) {
  ...
  case 3 :
   ...
   break;
# 1046 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
  default:
   val = 1;
  }
 }
...
# 1062 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT put_fat (
 FATFS* fs,
 DWORD clst,
...
# 1232 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
...
# 1289 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
  clst = nxt;
 } while (clst < fs->n_fatent);
# 1303 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 return FR_OK;
}
...
# 1352 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 {
  ncl = scl;
  for (;;) {
   ncl++;
...
# 1427 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_sdi (
 DIR* dp,
 DWORD ofs
...
# 1476 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_next (
 DIR* dp,
 int stretch
...
# 1546 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_alloc (
 DIR* dp,
 UINT nent
...
# 1589 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
DWORD ld_clust (
 FATFS* fs,
 const BYTE* dir
...
# 2089 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_read (
 DIR* dp,
 int vol
...
# 2123 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
  {
   dp->obj.attr = a = dp->dir[11] & 0x3F;
# 2145 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
...
# 2166 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_find (
 DIR* dp
)
{
 ...
 res = dir_sdi(dp, 0);
 if (res != FR_OK) return res;
# 2201 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 do {
  res = move_window(fs, dp->sect);
  if (res != FR_OK) break;
  c = dp->dir[0];
  if (c == 0) { res = FR_NO_FILE; break; }
# 2228 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
...
# 2245 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
...
)
{
 FRESULT res;
 FATFS *fs = dp->obj.fs;
# 2319 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 res = dir_alloc(dp, 1);
...
# 2348 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT dir_remove (
 DIR* dp
)
{
 FRESULT res;
 FATFS *fs = dp->obj.fs;
# 2377 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 res = move_window(fs, dp->sect);
 if (res == FR_OK) {
  dp->dir[0] = 0xE5;
  fs->wflag = 1;
...
# 2396 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
void get_fileinfo (
 DIR* dp,
 FILINFO* fno
)
{
 ...
 fno->fname[0] = 0;
 if (!dp->sect) return;
# 2472 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 i = j = 0;
 while (i < 11) {
  c = (TCHAR)dp->dir[i++];
  if (c == ' ') continue;
...
# 2570 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT create_name (
 DIR* dp,
 const TCHAR** path
...
{
# 2695 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 BYTE c, d, *sfn;
 UINT ni, si, i;
 const char *p;
 ...
 mem_set(sfn, ' ', 11);
 si = i = 0; ni = 8;
# 2716 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 for (;;) {
  c = (BYTE)p[si++];
  if (c <= ' ') break;
  if (c == '/' || c == '\\') {
...
# 2765 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT follow_path (
 DIR* dp,
 const TCHAR* path
...
# 2800 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 if ((UINT)*path < ' ') {
  dp->fn[11] = 0x80;
  res = dir_sdi(dp, 0);
...
# 2837 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   {
...
# 2853 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
int get_ldnumber (
 const TCHAR** path
)
{
 ...
 UINT i;
 int vol = -1;
# 2869 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 if (*path) {
...
# 2896 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   return vol;
  }
...
# 2914 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
BYTE check_fs (
 FATFS* fs,
 DWORD sect
...
# 2942 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT find_volume (
 const TCHAR** path,
 FATFS** rfs,
...
# 3063 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 {
 ...
 fs->fs_type = fmt;
 fs->id = ++Fsid;
# 3153 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 return FR_OK;
}
# 3163 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
static
FRESULT validate (
 _FDID* obj,
 FATFS** fs
...
# 3198 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_mount (
 FATFS* fs,
 const TCHAR* path,
 BYTE opt
...
# 3246 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_open (
 FIL* fp,
 const TCHAR* path,
 BYTE mode
 ...
 if (res == FR_OK) {
  ...
  if (mode & (0x08 | 0x10 | 0x04)) {
   ...
   if (res == FR_OK && (mode & 0x08)) {
    dw = get_fattime();
# 3326 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
    {
...
# 3380 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
  if (res == FR_OK) {
# 3391 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   {
...
# 3447 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_read (
 FIL* fp,
 void* buff,
 UINT btr,
...
# 3547 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_write (
 FIL* fp,
 const void* buff,
 UINT btw,
...
# 3668 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_sync (
 FIL* fp
)
{
 ...
 if (res == FR_OK) {
  if (fp->flag & 0x40) {
   ...
   tm = get_fattime();
# 3718 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   {
...
# 3747 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_close (
 FIL* fp
)
{
...
# 3935 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_lseek (
 FIL* fp,
 FSIZE_t ofs
)
{
 ...
 res = validate(&fp->obj, &fs);
 if (res != FR_OK || (res = (FRESULT)fp->err) != FR_OK) { unlock_fs(fs, res); return res; };
# 4003 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 {
...
# 4089 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_opendir (
 DIR* dp,
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
   if (!(dp->fn[11] & 0x80)) {
    if (obj->attr & 0x10) {
# 4122 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
     {
   ...
   if (res == FR_OK) {
    obj->id = fs->id;
    res = dir_sdi(dp, 0);
# 4142 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   }
  }
  ;
...
# 4159 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_closedir (
 DIR *dp
)
{
...
# 4192 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_readdir (
 DIR* dp,
 FILINFO* fno
)
...
# 4280 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_stat (
 const TCHAR* path,
 FILINFO* fno
)
...
# 4315 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_getfree (
 const TCHAR* path,
 DWORD* nclst,
 FATFS** fatfs
...
# 4366 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
    {
...
# 4402 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_truncate (
 FIL* fp
)
{
...
# 4452 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_unlink (
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
   ...
   if (res == FR_OK) {
# 4495 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
    {
...
# 4547 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_mkdir (
 const TCHAR* path
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_NO_FILE) {
   ...
   if (res == FR_OK) {
# 4615 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
    {
     dir = dj.dir;
     st_dword(dir + 22, tm);
     st_clust(fs, dir, dcl);
...
# 4640 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_rename (
...
)
{
 ...
 if (res == FR_OK) {
  ...
  if (res == FR_OK) {
# 4689 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
   {
...
# 5213 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_mkfs (
 const TCHAR* path,
 BYTE opt,
 DWORD au,
...
# 5462 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
 {
  do {
   pau = au;
...
# 5672 "/Users/Sentaro/esp/esp-idf/components/fatfs/src/ff.c"
FRESULT f_fdisk (
 BYTE pdrv,
 const DWORD* szt,
 void* work
